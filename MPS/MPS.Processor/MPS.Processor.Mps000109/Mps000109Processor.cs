    ...
    public class Mps000109Processor : AbstractProcessor
    {
        ...
        private void SetSingleKey()
        {
            try
            {
                ...
                {
                    var ratio = new MOS.LibraryHein.Bhyt.BhytHeinProcessor().GetDefaultHeinRatio(rdo.V_HIS_PATIENT_TYPE_ALTER.HEIN_TREATMENT_TYPE_CODE, rdo.V_HIS_PATIENT_TYPE_ALTER.HEIN_CARD_NUMBER, rdo.V_HIS_PATIENT_TYPE_ALTER.LEVEL_CODE, rdo.V_HIS_PATIENT_TYPE_ALTER.RIGHT_ROUTE_CODE, rdo.V_HIS_PATIENT_TYPE_ALTER.FACILITY_CLASS, rdo.V_HIS_PATIENT_TYPE_ALTER.FORMER_LEVEL_CODE, rdo.V_HIS_PATIENT_TYPE_ALTER.CLASSIFY_POINT ?? 0, rdo.hisTreatment != null ? rdo.hisTreatment.CLINICAL_IN_TIME ?? 0 : 0);
                    if (ratio.HasValue)
                    {
                    ...
                    if (!String.IsNullOrEmpty(rdo.V_HIS_PATIENT_TYPE_ALTER.HEIN_CARD_NUMBER))
                    {
                        ...
                        SetSingleKey((new KeyValue(Mps000109ExtendSingleKey.HEIN_CARD_NUMBER_6, rdo.V_HIS_PATIENT_TYPE_ALTER.HEIN_CARD_NUMBER.Substring(10))));

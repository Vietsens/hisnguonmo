...
namespace MPS.Processor.Mps000463.ADO
{
    class SereServADO : HIS_SERE_SERV
    {
        ...
        public SereServADO(HIS_SERE_SERV data, List<HIS_SERE_SERV> SereServs, List<HIS_SERE_SERV_EXT> sereServExts, List<HIS_HEIN_SERVICE_TYPE> heinServiceTypes,
            ...
            V_HIS_TREATMENT treatment, List<HIS_PATIENT_TYPE_ALTER> ListPta, List<HIS_SERVICE_REQ> serviceReqs)
        {
            try
            {
                #region Base
    ...
    || service.HEIN_SERVICE_TYPE_ID == IMSys.DbConfig.HIS_RS.HIS_HEIN_SERVICE_TYPE.ID__TH_TL)
                                ...
                                || service.HEIN_SERVICE_TYPE_ID == IMSys.DbConfig.HIS_RS.HIS_HEIN_SERVICE_TYPE.ID__TT)
                            {
                                ...
                                this.HEIN_SERVICE_TYPE_NAME = Inventec.Common.String.Convert.FirstCharToUpper(heinServiceTypeTT.HEIN_SERVICE_TYPE_NAME.ToLower()) + ", " + heinServiceTypePTTT.HEIN_SERVICE_TYPE_NAME.ToLower();
                            }
                                    ...
                                    || service.HEIN_SERVICE_TYPE_ID == IMSys.DbConfig.HIS_RS.HIS_HEIN_SERVICE_TYPE.ID__CPM)
                            {
                                ...
                                this.HEIN_SERVICE_TYPE_NAME =Inventec.Common.String.Convert.FirstCharToUpper(heinServiceTypeMAU.HEIN_SERVICE_TYPE_NAME.ToLower()) + ", " + heinServiceTypeCPM.HEIN_SERVICE_TYPE_NAME.ToLower();
                            }
                            else
                            {

...
namespace MPS.Processor.Mps000347.PDO
{
    public partial class Mps000347PDO : RDOBase
    {
        ...
        public List<Mps000347ADO> listAdo = new List<Mps000347ADO>();
            ...
            try
            {
                ...
                if (_expMestMetyReqs != null && _expMestMetyReqs.Count > 0)
                {
                        ...
                        || _ChmsExpMest.IS_REQUEST_BY_PACKAGE == 1)
                    {
                        ...
                        {
                          //  this.MEDICINE_USE_FORM_NUM_ORDER = 
                        }

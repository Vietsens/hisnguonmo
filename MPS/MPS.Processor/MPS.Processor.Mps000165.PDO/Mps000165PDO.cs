...
namespace MPS.Processor.Mps000165.PDO
{
    ...
    {
        public List<HIS_MACHINE> ListMachine { get; set; }

        public Mps000165PDO() { }

        public Mps000165PDO(V_HIS_EXP_MEST otherExpMest, List<V_HIS_EXP_MEST_MEDICINE> listMedicine, List<V_HIS_EXP_MEST_MATERIAL> listMaterial)
        {
        ...
        public Mps000165PDO(V_HIS_EXP_MEST otherExpMest, List<V_HIS_EXP_MEST_MEDICINE> listMedicine, List<V_HIS_EXP_MEST_MATERIAL> listMaterial, List<HIS_MACHINE> machine)
        {
            this.OtherExpMest = otherExpMest;
            this._Materials = listMaterial;
            this._Medicines = listMedicine;

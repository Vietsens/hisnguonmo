...
{
    public partial class Mps000517PDO
    {
        public HIS_PATIENT_TYPE_ALTER PatientTypeAlter { get; set; }

        // Kết quả XN đã GỘP từ nhiều mẫu (caller merge trước khi truyền vào PDO).
        public List<V_LIS_RESULT> lstLisResult { get; set; }
        public List<V_HIS_TEST_INDEX> lstTestIndex { get; set; }

        // Khác với Mps000096 (1 mẫu / 1 y lệnh): đa mẫu nên là List.
        public List<V_LIS_SAMPLE> currentSamples { get; set; }
        public List<HIS_SERVICE_REQ> currentServiceReqs { get; set; }

        public HIS_TREATMENT currentTreatment { get; set; }  // 1 BN nên giữ nguyên đơn
    ...
    {
        public const string Mps000517 = "Mps000517";
    }

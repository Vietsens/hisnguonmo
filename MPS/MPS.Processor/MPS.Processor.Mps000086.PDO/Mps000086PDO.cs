...
using static MPS.Processor.Mps000086.PDO.Mps000086ADO;
...
namespace MPS.Processor.Mps000086.PDO
{
    public partial class Mps000086PDO : RDOBase
    {
        ...
        public Mps000086Config ConfigMps86 { get; set; }
    ...
    List<HIS_BLOOD> _blood,
        ...
        )
        {
            ...
            this.listConfig = config;
            this._MedicineUserForms = _medicineUserForms;
            ConfigMps86 = _configMps86;
            if (ConfigMps86 == null)
            {
                ConfigMps86 = new Mps000086Config();
            }
        }
    }
}

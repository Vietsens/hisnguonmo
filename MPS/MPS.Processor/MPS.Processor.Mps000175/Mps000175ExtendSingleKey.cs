...
{
    public class Mps000175ExtendSingleKey : CommonKey
    {
        ...
        internal static string KEY_NAME_TITLES = "KEY_NAME_TITLES";

        internal static string CREATE_TIME_AGGR_STR = "CREATE_TIME_AGGR_STR";

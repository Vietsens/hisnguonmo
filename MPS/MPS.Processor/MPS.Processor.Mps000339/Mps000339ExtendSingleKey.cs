...
{
    class Mps000339ExtendSingleKey
    {
        ...
        internal static string SUM_TOTAL_PRICE_ROUND = "SUM_TOTAL_PRICE_ROUND";
        internal static string SUM_TOTAL_PRICE_ROUND_TEXT = "SUM_TOTAL_PRICE_ROUND_TEXT";

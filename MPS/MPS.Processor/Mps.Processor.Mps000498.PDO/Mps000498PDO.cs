...
namespace MPS.Processor.Mps000498.PDO
{
    public partial class Mps000498PDO
    {
        public Mps000498PDO(V_HIS_TREATMENT TreatmentView, HIS_TRANS_REQ TransReq, List<HIS_CONFIG> ConfigList)
        {
            try
            {

...
namespace MPS.Processor.Mps000031.PDO
{
    public partial class Mps000031PDO : RDOBase
    {
        public List<Mps000031_ListSereServ> sereServs { get; set; }
        ...
        public Mps000031ADO Mps000031ADO { get; set; }
    ...
    public class Mps000031_ListSereServ : V_HIS_SERE_SERV
    {
        ...
        public Mps000031_ListSereServ() { }

        public Mps000031_ListSereServ(V_HIS_SERE_SERV data)
        {
            try
            {
                if (data != null)
        ...
        public Mps000031_ListSereServ(V_HIS_SERE_SERV_11 data)
        {
            try
            {
                if (data != null)

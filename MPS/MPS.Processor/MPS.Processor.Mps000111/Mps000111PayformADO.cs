...
namespace MPS.Processor.Mps000111
{
    ...
    /// </summary>
    public class Mps000111PayformADO
    {
        /// <summary>
        /// So thu tu dong
        /// </summary>
        ...
        public Mps000111PayformADO() { }

        public Mps000111PayformADO(HIS_TRANSACTION_PAYFORM data, List<HIS_PAY_FORM> payForms, List<HIS_BANK> banks)
        {
            try
            {
                if (data == null) return;
        ...
        /// </summary>
        public Mps000111PayformADO(V_HIS_TRANSACTION tran)
        {
            try
            {
                if (tran == null) return;

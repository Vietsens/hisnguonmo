...
{
    class Mps000314ExtendSingleKey
    {
        ...
        internal const string THUA = "THUA";
        internal const string THUA_TEXT = "THUA_TEXT";
        internal const string THIEU = "THIEU";
        internal const string THIEU_TEXT = "THIEU_TEXT";

        internal const string FUND_CODE = "FUND_CODE";
        internal const string FUND_NAME = "FUND_NAME";
    }
}

...
namespace MPS.Processor.Mps000504.ADO
{
    ...
    || service.HEIN_SERVICE_TYPE_ID == IMSys.DbConfig.HIS_RS.HIS_HEIN_SERVICE_TYPE.ID__TH_TL)
                ...
                this.TOTAL_PATIENT_PRICE_LEFT = (this.VIR_TOTAL_PRICE_NO_EXPEND ?? 0) - (this.VIR_TOTAL_HEIN_PRICE ?? 0) - (this.VIR_TOTAL_PATIENT_PRICE_BHYT ?? 0) - (this.OTHER_SOURCE_PRICE ?? 0);
                ...
                HIS_OTHER_PAY_SOURCE source = _listOtherPaySource != null ? _listOtherPaySource.FirstOrDefault(o => o.ID == this.OTHER_PAY_SOURCE_ID) : null;
                if (source != null)
                {
                    this.OTHER_PAY_SOURCE_NAME = source.OTHER_PAY_SOURCE_NAME;
                }

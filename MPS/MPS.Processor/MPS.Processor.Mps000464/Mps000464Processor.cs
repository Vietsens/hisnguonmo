    ...
    class Mps000464Processor : AbstractProcessor
    {
        ...
        private void SetConclusionIcdKeysFromGeneral()
        {
            try
            {
                ...
                SetSingleKey(new KeyValue(Mps000464ExtendSingleKey.CONCLUSION_ICD_NONE_X, icdType == 1 ? "x" : ""));
                SetSingleKey(new KeyValue(Mps000464ExtendSingleKey.CONCLUSION_ICD_PRELIM_X, icdType == 2 ? "x" : ""));
                SetSingleKey(new KeyValue(Mps000464ExtendSingleKey.CONCLUSION_ICD_FINAL_X, icdType == 3 ? "x" : ""));
                SetSingleKey(new KeyValue(Mps000464ExtendSingleKey.CONCLUSION_ICD_CODE,
                    (kskGeneral != null ? kskGeneral.CONCLUSION_ICD_CODE : null) ?? ""));
                SetSingleKey(new KeyValue(Mps000464ExtendSingleKey.CONCLUSION_ICD_NAME,

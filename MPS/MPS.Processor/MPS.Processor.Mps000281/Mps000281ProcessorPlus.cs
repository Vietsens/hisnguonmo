        ...
        internal void DataInputProcess()
        {
            try
            {
                ...
                sereServADOTemps.AddRange(from r in rdo.SereServs
                                          ...
                                          rdo.medicineTypes, rdo.MedicineLines, rdo.materialTypes, rdo.PatientTypeCFG, rdo.HisServiceUnit,
                                          rdo.ServiceReqs, rdo.PatientTypeAlterAlls, rdo.HisConfigValue, rdo.Treatment
                                          ));
                ...
                sereServADOs = sereServADOs.OrderBy(o => o.HEIN_SERVICE_TYPE_NUM_ORDER ?? 99999).ThenBy(o => o.HEIN_SERVICE_TYPE_CHILD_NUM_ORDER ?? 99999).ThenBy(o => o.SERVICE_NAME).ToList();

                var fullss = sereServADOTemps.Where(o =>
                          o.AMOUNT > 0
                          && ((o.PATIENT_TYPE_ID == rdo.PatientTypeCFG.PATIENT_TYPE__BHYT && (o.VIR_TOTAL_HEIN_PRICE ?? 0) <= 0) || o.PATIENT_TYPE_ID != rdo.PatientTypeCFG.PATIENT_TYPE__BHYT)
                          && o.PRICE > 0
                          && o.IS_EXPEND != 1
            ...
            try
            {
                if (sereServs != null && sereServs.Count > 0)
                {
                    ...
                    .Where(o =>
                        ...
                        && o.PRICE > 0
                        && o.IS_EXPEND != 1)
                        //.OrderBy(o => o.HEIN_SERVICE_TYPE_NUM_ORDER ?? 99999).ThenBy(o => o.HEIN_SERVICE_TYPE_CHILD_NUM_ORDER ?? 99999).ThenBy(o => o.SERVICE_NAME)
                    .GroupBy(o => new
                    {
                        o.SERVICE_ID,
                        o.PRICE,
        ...
        internal void HeinServiceTypeProcess()
        {
            try
            {
                ...
                foreach (var sereServBHYTGroup in sereServBHYTGroups)
                {
                    ...
                    {
                        if (heinServiceTypeADOs.Select(o => o.ID).Contains(HeinServiceTypeExt.BED__ID))
                            continue;
                        else
                        {

...
{
    /// <summary>
    /// Mot dong dich vu tren phieu thu tam ung Mps000112
    /// </summary>
    public class Mps000112ServiceADO
    {
        /// <summary>
        /// So thu tu dong
        /// </summary>
        ...
        public Mps000112ServiceADO() { }

        public Mps000112ServiceADO(V_HIS_SERE_SERV data)
        {
            try
            {
                if (data == null) return;

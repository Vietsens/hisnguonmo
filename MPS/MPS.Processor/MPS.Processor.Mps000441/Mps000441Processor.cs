...
namespace MPS.Processor.Mps000441
{
    public partial class Mps000441Processor : AbstractProcessor
    {
        ...
        private List<MPS.Processor.Mps000441.ADO.SurchargeADO> SurchargeProcess()
        {
            List<MPS.Processor.Mps000441.ADO.SurchargeADO> result = new List<MPS.Processor.Mps000441.ADO.SurchargeADO>();
            try
            {
                ...
                {
                    result.Add(new MPS.Processor.Mps000441.ADO.SurchargeADO()
                    {
                        STT = stt++,
        ...
        private void ProcessSingleKey()
        {
            try
            {
                ...
                // PTTK 2656 - mục 4.2.8: cộng phụ phí vào tổng cộng + set key section phụ phí
                ...
                SetSingleKey(new KeyValue("SURCHARGE_SECTION_NO", surchargeSectionNo));
                SetSingleKey(new KeyValue("SURCHARGE_SECTION_LABEL", surchargeCount > 0 ? (surchargeSectionNo + ". Phụ phí") : ""));

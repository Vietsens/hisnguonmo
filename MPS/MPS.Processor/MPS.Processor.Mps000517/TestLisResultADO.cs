...
namespace MPS.Processor.Mps000517
{
    class TestLisResultADO : V_HIS_SERE_SERV_TEIN
    {
        ...
        // ===== Mps000517: chiều gom nhóm thứ 2 — Loại XN (HH/SH/MD/VS...) =====
        public long? TEST_TYPE_ID { get; set; }
        public string TEST_TYPE_CODE { get; set; }
        public string TEST_TYPE_NAME { get; set; }
        /// <summary>
        /// Khóa gom nhóm tầng giữa = "{SERVICE_PARENT_ID}_{TEST_TYPE_ID}".
        /// Duy nhất cho mỗi cặp (nhóm DV cha, loại XN) → dùng nối ListTestType ▷ ListTestParent.
        /// </summary>

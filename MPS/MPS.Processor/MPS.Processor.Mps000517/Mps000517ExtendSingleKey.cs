...
{
    class Mps000517ExtendSingleKey
    {
        ...
        internal const string PATIENT_CONDITION_NAME = "PATIENT_CONDITION_NAME";
        ...
        internal const string BARCODE_SERVICE_REQ_CODE_STR = "BARCODE_SERVICE_REQ_CODE";
        ...
        // Mps000517: gộp mã barcode/y lệnh nhiều mẫu để in lên header
        internal const string SAMPLE_BARCODEs = "SAMPLE_BARCODEs";
        internal const string SERVICE_REQ_CODEs = "SERVICE_REQ_CODEs";
    }
}

...
{
    class Mps000049ExtendSingleKey
    {
        ...
        internal const string EXP_MEST_CODE_BAR = "EXP_MEST_CODE_BAR";
        ...
        internal const string PARENT_TYPE_CODE = "PARENT_TYPE_CODE";

        internal const string CREATE_TIME_AGGR_STR = "CREATE_TIME_AGGR_STR";
        ...
        /// </summary>
        internal const string SEPARATE_FUNCTIONAL_FOOD = "SEPARATE_FUNCTIONAL_FOOD";

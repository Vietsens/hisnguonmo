...
namespace MPS.Processor.Mps000141.PDO
{
    ...
    {
        public Mps000141PDO() { }
        public Mps000141PDO(V_HIS_IMP_MEST manuImpMest, List<V_HIS_IMP_MEST_MEDICINE> impMestMedicines, List<V_HIS_IMP_MEST_MATERIAL> impMestMaterials, List<HIS_MEDICINE> _medicines, List<HIS_MATERIAL> _materials, List<HIS_IMP_SOURCE> _listImpSource)
        {
        ...
        public Mps000141PDO(V_HIS_IMP_MEST manuImpMest, List<V_HIS_IMP_MEST_MEDICINE> impMestMedicines, List<V_HIS_IMP_MEST_MATERIAL> impMestMaterials, List<HIS_MEDICINE> _medicines, List<HIS_MATERIAL> _materials, List<HIS_IMP_SOURCE> _listImpSource, List<MedicalContractADO> listMedicalContract)
        {
            this._ManuImpMest = manuImpMest;
            this._ImpMestMaterials = impMestMaterials;
            this._ImpMestMedicines = impMestMedicines;

    ...
    public partial class Mps000120Processor : AbstractProcessor
    {
        ...
        void ProcessSingleKey()
        {
            try
            {
                ...
                // PTTK 2656 - mục 4.2.8: gộp phụ phí vào "Tổng cộng" (cột 5 Thành tiền + cột 9 Người bệnh tự trả)
                ...
                SetSingleKey(new KeyValue(Mps000120ExtendSingleKey.SURCHARGE_COUNT, surchargeCount));
                int surchargeSectionNo = (heinServiceTypeADOs != null ? heinServiceTypeADOs.Count : 0) + 1;
                SetSingleKey(new KeyValue(Mps000120ExtendSingleKey.SURCHARGE_SECTION_NO, surchargeSectionNo));
                // Nhãn header mục phụ phí: "N. Phụ phí" khi có phụ phí; rỗng khi không (template tự ẩn dòng)
                SetSingleKey(new KeyValue(Mps000120ExtendSingleKey.SURCHARGE_SECTION_LABEL,
                ...
                // [DEBUG PTTK 2656] — xác nhận MPS Mps000120 nhận được SurchargePayforms. XÓA sau khi test.
                Inventec.Common.Logging.LogSystem.Debug(
                    "___PTTK2656_SURCHARGE___ [6-Mps000120] rdo.SurchargePayforms="

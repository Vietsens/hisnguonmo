...
namespace MPS.ProcessorBase
{
    ...
    {
        /// <summary>
        /// Hiển thị định dạng 13 giờ 37 phút, Ngày 13 tháng 11 năm 2019
        /// </summary>
        /// <returns></returns>
        public static string GetCurrentTimeSeparateNoSecond(System.DateTime now)
        {
            string result = "";
            try
            {
                if (now != DateTime.MinValue)
                {
                    ...
                    string strGio = "giờ";
                    string strPhut = "phút";
                    result = string.Format("{0} " + strGio + " " + "{1} " + strPhut + ", " + strNgay + " {2} " + strThang + " {3} " + strNam + " {4}", hours, minute, now.Day, now.Month, now.Year);
                }
            }
            catch (Exception ex)
            {
        ...
        /// </summary>
        /// <returns></returns>
        public static string GetCurrentTimeSeparateBeginTime(System.DateTime now)
        {
            string result = "";
            try
            {
        ...
        /// </summary>
        /// <returns></returns>
        public static string GetCurrentTimeSeparate(System.DateTime now)
        {
            string result = "";
            try
            {
        ...
        //public static void AddObjectKeyIntoListkey<T>(T data, List<MPS.ProcessorBase.Core.KeyValue> keyValues)
        //{
        //    try
        //    {
        ...
        //public static void AddObjectKeyIntoListkey<T>(T data, List<MPS.ProcessorBase.Core.KeyValue> keyValues, bool isOveride)
        //{
        //    try
        //    {
        ...
        //public static void AddSingeKey(List<MPS.ProcessorBase.Core.KeyValue> keyValues, string key, object value, bool isOveride)
        //{
        //    try
        //    {
        ...
        //public static void AddSingeKey(List<MPS.ProcessorBase.Core.KeyValue> keyValues, string key, object value)
        //{
        //    try
        //    {
        ...
        public static string TrimHeinCardNumber(string heinCardNumber)
        {
            string result = "";
            try
            {

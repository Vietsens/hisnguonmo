...
using HIS.Desktop.Plugins.KskInfomantionOfficials.Resources;
using HIS.Desktop.Utilities.Extensions;
using DevExpress.XtraEditors.Repository;
using DevExpress.XtraEditors.Controls;
using HIS.Desktop.LocalStorage.BackendData;
using Inventec.Desktop.Common.Message;
using HIS.Desktop.Plugins.KskInfomantionOfficials.Config;
...
namespace HIS.Desktop.Plugins.KskInfomantionOfficials
{
    ...
    public partial class frmKskInfomantionOfficials : HIS.Desktop.Utility.FormBase
    {
        #region Declare
        int rowCount = 0;
        int dataTotal = 0;
        ...
        string moduleLink = "HIS.Desktop.Plugins.KskInfomantionOfficials";
        ...
        #region Construct
        public frmKskInfomantionOfficials(Inventec.Desktop.Common.Modules.Module moduleData, string serviceReqCode)
            : base(moduleData)
        {
            try
            {
        ...
        private void frmKskInfomantionOfficials_Load(object sender, EventArgs e)
        {
            try
            {
                MeShow();
        ...
        private void FillDataToEditorControl(ADO.ServiceReqADO data)
        {
            try
            {
                if (data != null)
                {
                    ...
                    LoadOfficialsFormData(data);
                }
                else
                {
                    ResetOfficialsFormData();
                }
            }
            catch (Exception ex)
            {
        ...
        private void FillDataToDHSTBmiTab1()
        {
            try
            {
                ...
                if (bmi < 16)
                {
                    lblBmiDisplayTextTab1.Text = Inventec.Common.Resource.Get.Value("frmKskInfomantionOfficials.SKINNY.III", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                }
                else if (16 <= bmi && bmi < 17)
                {
                    lblBmiDisplayTextTab1.Text = Inventec.Common.Resource.Get.Value("frmKskInfomantionOfficials.SKINNY.II", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                }
                else if (17 <= bmi && bmi < (decimal)18.5)
                {
                    lblBmiDisplayTextTab1.Text = Inventec.Common.Resource.Get.Value("frmKskInfomantionOfficials.SKINNY.I", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                }
                else if ((decimal)18.5 <= bmi && bmi < 25)
                {
                    lblBmiDisplayTextTab1.Text = Inventec.Common.Resource.Get.Value("frmKskInfomantionOfficials.BMIDISPLAY.NORMAL", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                }
                else if (25 <= bmi && bmi < 30)
                {
                    lblBmiDisplayTextTab1.Text = Inventec.Common.Resource.Get.Value("frmKskInfomantionOfficials.BMIDISPLAY.OVERWEIGHT", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                }
                else if (30 <= bmi && bmi < 35)
                {
                    lblBmiDisplayTextTab1.Text = Inventec.Common.Resource.Get.Value("frmKskInfomantionOfficials.BMIDISPLAY.OBESITY.I", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                }
                else if (35 <= bmi && bmi < 40)
                {
                    lblBmiDisplayTextTab1.Text = Inventec.Common.Resource.Get.Value("frmKskInfomantionOfficials.BMIDISPLAY.OBESITY.II", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                }
                else if (40 < bmi)
                {
                    lblBmiDisplayTextTab1.Text = Inventec.Common.Resource.Get.Value("frmKskInfomantionOfficials.BMIDISPLAY.OBESITY.III", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                }
            }
            catch (Exception ex)
            {
        ...
        private void FillDataToDHSTBmiTab3()
        {
            try
            {
                ...
                if (bmi < 16)
                {
                    lblBmiDisplayTextTab3.Text = Inventec.Common.Resource.Get.Value("frmKskInfomantionOfficials.SKINNY.III", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                }
                else if (16 <= bmi && bmi < 17)
                {
                    lblBmiDisplayTextTab3.Text = Inventec.Common.Resource.Get.Value("frmKskInfomantionOfficials.SKINNY.II", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                }
                else if (17 <= bmi && bmi < (decimal)18.5)
                {
                    lblBmiDisplayTextTab3.Text = Inventec.Common.Resource.Get.Value("frmKskInfomantionOfficials.SKINNY.I", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                }
                else if ((decimal)18.5 <= bmi && bmi < 25)
                {
                    lblBmiDisplayTextTab3.Text = Inventec.Common.Resource.Get.Value("frmKskInfomantionOfficials.BMIDISPLAY.NORMAL", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                }
                else if (25 <= bmi && bmi < 30)
                {
                    lblBmiDisplayTextTab3.Text = Inventec.Common.Resource.Get.Value("frmKskInfomantionOfficials.BMIDISPLAY.OVERWEIGHT", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                }
                else if (30 <= bmi && bmi < 35)
                {
                    lblBmiDisplayTextTab3.Text = Inventec.Common.Resource.Get.Value("frmKskInfomantionOfficials.BMIDISPLAY.OBESITY.I", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                }
                else if (35 <= bmi && bmi < 40)
                {
                    lblBmiDisplayTextTab3.Text = Inventec.Common.Resource.Get.Value("frmKskInfomantionOfficials.BMIDISPLAY.OBESITY.II", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                }
                else if (40 < bmi)
                {
                    lblBmiDisplayTextTab3.Text = Inventec.Common.Resource.Get.Value("frmKskInfomantionOfficials.BMIDISPLAY.OBESITY.III", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                }
            }
            catch (Exception ex)
            {
        ...
        private void ApplyHiddenTabOption()
        {
            ...
            xtraTabPage9.Text = "Tiền sử bệnh";
            xtraTabPage10.Text = "Khám lâm sàng";
            xtraTabPage11.Text = "Kết luận";
                    ...
                    if (info.InRowCell)
                    {
                        if (lastRowHandle != info.RowHandle || lastColumn != info.Column)
                        {
                            ...
                            if (info.Column.FieldName == "TRANGTHAI_IMG")
                            {
                                ...
                                {
                                    text = Inventec.Common.Resource.Get.Value("frmKskInfomantionOfficials.ToolTipControl.CXL", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                                }
                                else if (serviceReqSTTId == IMSys.DbConfig.HIS_RS.HIS_SERVICE_REQ_STT.ID__DXL)
                                {
                                    text = Inventec.Common.Resource.Get.Value("frmKskInfomantionOfficials.ToolTipControl.DXL", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                                }
                                else if (serviceReqSTTId == IMSys.DbConfig.HIS_RS.HIS_SERVICE_REQ_STT.ID__HT)
                                {
                                    text = Inventec.Common.Resource.Get.Value("frmKskInfomantionOfficials.ToolTipControl.KT", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                                }
        ...
        private void RightMenuCheck_Click(object sender, ItemClickEventArgs e)
        {
            try
            {
                if (e.Item is BarButtonItem)
                {
                    ...
                    switch (type)
                    {
                        case PopupMenuProcessorCheck.ItemType.InMps507:
                            PrintMps000507();
                            break;
                        default:
                            break;
        ...
        private void FillDataToDHSTBmiTab5()
        {
            try
            {
                ...
                if (bmi < 16)
                {
                    lblBmi.Text = Inventec.Common.Resource.Get.Value("frmKskInfomantionOfficials.SKINNY.III", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                }
                else if (16 <= bmi && bmi < 17)
                {
                    lblBmi.Text = Inventec.Common.Resource.Get.Value("frmKskInfomantionOfficials.SKINNY.II", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                }
                else if (17 <= bmi && bmi < (decimal)18.5)
                {
                    lblBmi.Text = Inventec.Common.Resource.Get.Value("frmKskInfomantionOfficials.SKINNY.I", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                }
                else if ((decimal)18.5 <= bmi && bmi < 25)
                {
                    lblBmi.Text = Inventec.Common.Resource.Get.Value("frmKskInfomantionOfficials.BMIDISPLAY.NORMAL", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                }
                else if (25 <= bmi && bmi < 30)
                {
                    lblBmi.Text = Inventec.Common.Resource.Get.Value("frmKskInfomantionOfficials.BMIDISPLAY.OVERWEIGHT", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                }
                else if (30 <= bmi && bmi < 35)
                {
                    lblBmi.Text = Inventec.Common.Resource.Get.Value("frmKskInfomantionOfficials.BMIDISPLAY.OBESITY.I", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                }
                else if (35 <= bmi && bmi < 40)
                {
                    lblBmi.Text = Inventec.Common.Resource.Get.Value("frmKskInfomantionOfficials.BMIDISPLAY.OBESITY.II", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                }
                else if (40 < bmi)
                {
                    lblBmi.Text = Inventec.Common.Resource.Get.Value("frmKskInfomantionOfficials.BMIDISPLAY.OBESITY.III", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                }
            }
            catch (Exception ex)
            {

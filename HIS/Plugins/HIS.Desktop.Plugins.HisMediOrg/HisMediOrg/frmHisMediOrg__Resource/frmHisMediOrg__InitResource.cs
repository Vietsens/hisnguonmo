 ...
 */
        private void SetCaptionByLanguageKey()
        {
            try
            {
                ...
                Resources.ResourceLanguageManager.LanguageResource = new ResourceManager("HIS.Desktop.Plugins.HisMediOrg.Resources.Lang", typeof(HIS.Desktop.Plugins.HisMediOrg.HisMediOrg.frmHisMediOrg__Resource).Assembly);
                ...
                this.layoutControlItem13.Text = Inventec.Common.Resource.Get.Value("frmHisMediOrg.layoutControlItem13.Text", Resources.ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());

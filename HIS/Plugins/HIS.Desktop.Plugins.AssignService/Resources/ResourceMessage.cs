    ...
    class ResourceMessage
    {
        ...
        internal static string TongChiPhiVuot15PhanTramLuongCoBan
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("Plugin_AssignService__TongChiPhiVuot15PhanTramLuongCoBan", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);

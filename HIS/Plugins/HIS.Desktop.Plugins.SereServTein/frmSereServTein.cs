            ...
            try
            {
                ...
                if (this.lstSereServ != null && this.lstSereServ.Count > 0)
                {
                    ...
                    if (sereServTeinToCheck != null && sereServTeinToCheck.Count() > 0)
                    {
                        ...
                        var sereServTein = sereServTeinToCheck.Where(o => !String.IsNullOrEmpty(o.VALUE)).FirstOrDefault();
                    ...
                    else
                    {
                        try
                        {
                            ...
                            if (View1Tein != null && View1Tein.Count > 0)
                            {
                                ...
                                var sereServTein = View1Tein.Where(o => !String.IsNullOrEmpty(o.VALUE) && o.TDL_INTRUCTION_TIME < currentServiceReq.INTRUCTION_TIME).OrderByDescending(s => s.TDL_INTRUCTION_TIME).ThenByDescending(o => o.ID).FirstOrDefault();

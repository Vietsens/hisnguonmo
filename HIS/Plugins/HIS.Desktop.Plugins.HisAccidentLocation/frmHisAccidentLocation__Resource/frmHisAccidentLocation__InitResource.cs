 ...
 */
        private void SetCaptionByLanguageKey()
        {
            try
            {
                ...
                Resources.ResourceLanguageManager.LanguageResource = new ResourceManager("HIS.Desktop.Plugins.HisAccidentLocation.Resources.Lang", typeof(HIS.Desktop.Plugins.HisAccidentLocation.frmHisAccidentLocation__Resource).Assembly);
                ...
                this.Text = Inventec.Common.Resource.Get.Value("frmHisAccidentLocation.Text", Resources.ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
            }
            catch (Exception ex)
            {

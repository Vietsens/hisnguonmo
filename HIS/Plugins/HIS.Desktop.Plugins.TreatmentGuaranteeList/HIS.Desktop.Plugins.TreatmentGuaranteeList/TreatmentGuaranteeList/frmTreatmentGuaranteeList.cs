...
using HIS.Desktop.Plugins.TreatmentGuaranteeList.Properties;
...
{
    public partial class frmTreatmentGuaranteeList : HIS.Desktop.Utility.FormBase
    {
        int rowCount = 0;
        int dataTotal = 0;
        int startPage = 0;
        ...
        public frmTreatmentGuaranteeList(Inventec.Desktop.Common.Modules.Module module) : base(module)
        {
            InitializeComponent();
        ...
        private void frmTreatmentGuaranteeList_Load(object sender, EventArgs e)
        {
        ...
        private void SelectionGrid__EndDepartment(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!isLoadForm)
                {
                    ...
                    {
                        cboKhoaKetThuc.Properties.DataSource = listRoom.Where(o => _EndDepartmentSelecteds.Select(p => p.DEPARTMENT_CODE).ToList().Contains(o.DEPARTMENT_CODE)).ToList();
        ...
        private void LoadPaging(Object param)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        filter.TDL_PATIENT_TYPE_IDs = this._DienDieuTriSelecteds.Select(o => o.ID).ToList();
                    }

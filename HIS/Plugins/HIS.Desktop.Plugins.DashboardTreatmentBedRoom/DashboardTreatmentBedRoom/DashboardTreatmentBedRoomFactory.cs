...
{
    class DashboardTreatmentBedRoomFactory
    {
        internal static IDashboardTreatmentBedRoom MakeIDashboardTreatmentBedRoom(CommonParam param, object[] data)
        {
            IDashboardTreatmentBedRoom result = null;
            try
            {
                result = new DashboardTreatmentBedRoomBehavior(param, data);

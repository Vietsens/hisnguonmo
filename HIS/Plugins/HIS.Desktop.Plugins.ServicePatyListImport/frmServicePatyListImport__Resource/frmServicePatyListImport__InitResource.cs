 ...
 */
        private void SetCaptionByLanguageKey()
        {
            try
            {
                ...
                Resources.ResourceLanguageManager.LanguageResource = new ResourceManager("Plugins.Resources.Lang", typeof(Plugins.HIS.Desktop.Plugins.ServicePatyListImport.frmServicePatyListImport__Resource).Assembly);
                ...
                this.Text = Inventec.Common.Resource.Get.Value("frmServicePatyListImport.Text", Resources.ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
            }
            catch (Exception ex)
            {

...
namespace HIS.Desktop.Plugins.ImpMestLookup.ImpMestLookup.Resources
{
    class ResourceMessage
    {
        static System.Resources.ResourceManager languageMessage = new System.Resources.ResourceManager("HIS.Desktop.Plugins.ImpMestLookup.Resources.Message.Lang", System.Reflection.Assembly.GetExecutingAssembly());
        ...
        /// <summary>Không tìm thấy phiếu nhập có mã {0}</summary>
        internal static string KhongTimThayPhieuNhapCoMa
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("KhongTimThayPhieuNhapCoMa", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);

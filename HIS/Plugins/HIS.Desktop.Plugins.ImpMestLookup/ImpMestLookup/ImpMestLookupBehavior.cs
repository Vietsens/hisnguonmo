...
{
    class ImpMestLookupBehavior : BusinessBase, IImpMestLookup
    {
        object[] entity;

        internal ImpMestLookupBehavior(CommonParam param, object[] filter)
            : base()
        {
            entity = filter;
        }

        object IImpMestLookup.Run()
        {
            try
            {

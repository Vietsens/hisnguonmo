    ...
    public partial class frmImpMestViewDetail : HIS.Desktop.Utility.FormBase
    {
        ...
        private void InPhieuNhapChuyenKhoMau(string printTypeCode, string fileName, ref bool result)
        {
            try
            {
                ...
                Inventec.Common.SignLibrary.ADO.InputADO inputADO = new HIS.Desktop.Plugins.Library.EmrGenerate.EmrGenerateProcessor().GenerateInputADOWithPrintTypeCode("Mps00000", printTypeCode, moduleData != null ? moduleData.RoomId : 0);
        ...
        private void InPhieuNhapChuyenKho(string printTypeCode, string fileName, ref bool result)
        {
            try
            {
                if ((this.impMestMedicines != null && this.impMestMedicines.Count > 0) || (this.impMestMaterials != null && this.impMestMaterials.Count > 0))
                {
                    ...
                    Inventec.Common.SignLibrary.ADO.InputADO inputADO = new HIS.Desktop.Plugins.Library.EmrGenerate.EmrGenerateProcessor().GenerateInputADOWithPrintTypeCode("Mps00000", printTypeCode, this.currentModuleBase != null ? this.currentModuleBase.RoomId : 0);

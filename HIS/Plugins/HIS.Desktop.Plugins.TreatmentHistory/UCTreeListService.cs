...
using HIS.Desktop.Plugins.TreatmentHistory.Key;
    ...
    public partial class UCTreeListService : UserControl
    {
        ...
        private List<DevExpress.Utils.Menu.DXMenuItem> menuItem(DHisSereServ2 data)
        {
            ...
            try
            {
                ...
                if (data != null && data.TDL_SERVICE_TYPE_ID == IMSys.DbConfig.HIS_RS.HIS_SERVICE_TYPE.ID__G)
                {
                    ...
                    dXmenu.Caption = Inventec.Common.Resource.Get.Value("IVT_LANGUAGE_KEY__UC_BED_ROOM_PARTIAL__MOUSE_RIGHT__KE_DON_DUOC", Base.ResourceLangManager.LanguageUCTreatmentHistory, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
            ...
            try
            {
                if (e.SelectedControl is DevExpress.XtraTreeList.TreeList)// trvService)
                {
                    ...
                    if (hi != null && hi.Node != null)
                    {
                        ...
                        if (hi.Column != null && hi.Column.FieldName == "NOTE_ADO")
                        {
                            string textx = "";
                        ...
                        if (hi.Column != null && hi.Column.FieldName == "Edit")
                        {
        ...
        private void SetCaptionByLanguageKey()
        {
            try
            {
                ...
                Resources.ResourceLanguageManager.LanguageResource__UCTreeListService = new ResourceManager("HIS.Desktop.Plugins.TreatmentHistory.Resources.Lang", typeof(UCTreeListService).Assembly);

...
namespace HIS.Desktop.Plugins.DepositRequest.Validtion
{
    class SpinTranferAmountValidationRule : DevExpress.XtraEditors.DXErrorProvider.ValidationRule
    {
        ...
        public override bool Validate(System.Windows.Forms.Control control, object value)
        {
            ...
            try
            {
                ...
                {
                    ErrorText = HIS.Desktop.LibraryMessage.MessageUtil.GetMessage(HIS.Desktop.LibraryMessage.Message.Enum.TruongDuLieuBatBuoc);

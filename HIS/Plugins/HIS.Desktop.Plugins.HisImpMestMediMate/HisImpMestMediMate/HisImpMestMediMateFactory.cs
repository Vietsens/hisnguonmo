...
{
    class HisImpMestMediMateFactory
    {
        internal static IHisImpMestMediMate MakeIControl(CommonParam param, object[] data)
        {
            IHisImpMestMediMate result = null;
            try
            {
                result = new HisImpMestMediMateBehavior(param, data);

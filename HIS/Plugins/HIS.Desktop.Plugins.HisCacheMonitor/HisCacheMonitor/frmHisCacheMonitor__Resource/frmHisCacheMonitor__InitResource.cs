 ...
 */
        private void SetCaptionByLanguageKey()
        {
            try
            {
                ...
                Resources.ResourceLanguageManager.LanguageResource = new ResourceManager("HIS.Desktop.Plugins.HisCacheMonitor.Resources.Lang", typeof(HIS.Desktop.Plugins.HisCacheMonitor.HisCacheMonitor.frmHisCacheMonitor__Resource).Assembly);
                ...
                this.Text = Inventec.Common.Resource.Get.Value("frmHisCacheMonitor.Text", Resources.ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
            }
            catch (Exception ex)
            {

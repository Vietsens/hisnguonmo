 ...
 */
        private void SetCaptionByLanguageKey()
        {
            try
            {
                ...
                Resources.ResourceLanguageManager.LanguageResource = new ResourceManager("HIS.Desktop.Plugins.LisMachineIndex.Resources.Lang", typeof(HIS.Desktop.Plugins.LisMachineIndex.LisMachineIndex.frmLisMachineIndex__Resource).Assembly);
                ...
                this.cboMachineType.Properties.NullText = Inventec.Common.Resource.Get.Value("frmLisMachineIndex.cboMachineType.Properties.NullText", Resources.ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                ...
                this.dnNavigation.Text = Inventec.Common.Resource.Get.Value("frmLisMachineIndex.dnNavigation.Text", Resources.ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());

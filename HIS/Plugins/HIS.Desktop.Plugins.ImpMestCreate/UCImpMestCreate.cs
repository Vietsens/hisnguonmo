        ...
        private void btnAdd1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (this.currrentServiceAdo.IsMedicine)
                {
                    ...
                    else if (this.currrentServiceAdo.MEDICINE_LINE_ID != IMSys.DbConfig.HIS_RS.HIS_MEDICINE_LINE.ID__VT_YHCT && !String.IsNullOrEmpty(this.currrentServiceAdo.activeIngrBhytCode)) // this.currrentServiceAdo.MEDICINE_LINE_ID != IMSys.DbConfig.HIS_RS.HIS_MEDICINE_LINE.ID__VT_YHCT &&
                    {
        ...
        private void btnUpdate1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (this.currrentServiceAdo.IsMedicine)
                {
                    ...
                    else if (this.currrentServiceAdo.MEDICINE_LINE_ID != IMSys.DbConfig.HIS_RS.HIS_MEDICINE_LINE.ID__VT_YHCT && !String.IsNullOrEmpty(this.currrentServiceAdo.activeIngrBhytCode)) // 
                    {
                        XtraMessageBox.Show("Dạng bào chế không được để trống!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        return;
                    }

...
namespace HIS.Desktop.Plugins.SereServTemplate.Resources
{
    ...
    {
        static System.Resources.ResourceManager languageMessage = new System.Resources.ResourceManager("HIS.Desktop.Plugins.SereServTemplate.Resources.Message.Lang", System.Reflection.Assembly.GetExecutingAssembly());
        ...
        internal static string BanChuaChonDuLieuXuat
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("BanChuaChonDuLieuXuat", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);
        ...
        internal static string KhongTimThayFileNhap
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("KhongTimThayFileNhap", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);
        ...
        internal static string ThongBaoImport
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("ThongBaoImport", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);

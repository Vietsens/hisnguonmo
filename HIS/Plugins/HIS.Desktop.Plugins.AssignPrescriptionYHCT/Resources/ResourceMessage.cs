...
namespace HIS.Desktop.Plugins.AssignPrescriptionYHCT.Resources
{
    class ResourceMessage
    {
        static System.Resources.ResourceManager languageMessage = new System.Resources.ResourceManager("HIS.Desktop.Plugins.AssignPrescriptionYHCT.Resources.Message.Lang", System.Reflection.Assembly.GetExecutingAssembly());
        ...
        internal static string BanCoMuonCapNhatHuongDanThuocTrongDOnTheoHUongDanMoiKhong
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("BanCoMuonCapNhatHuongDanThuocTrongDOnTheoHUongDanMoiKhong", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);
        ...
        internal static string CacThuocDaKeThieuThongTinBatBuoc
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("CacThuocDaKeThieuThongTinBatBuoc", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);
        ...
        internal static string BanChuaChonBenhNhan
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("BanChuaChonBenhNhan", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);
        ...
        internal static string BanChuaChonKhoXuat
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("Plugin_AssignPrescription__BanChuaChonKhoXuat", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);

    ...
    public partial class frmAssignPrescription : HIS.Desktop.Utility.FormBase
    {
        ...
        private void InitComboMediStockAllow(long patienTypeId)
        {
            try
            {
                ...
                // Lọc kho theo loại (kho điều trị / tủ trực / ngoại trú) — chỉ khi bật cấu hình
                // ENABLE_TREATMENT_PRESCRIPTION. Khi TẮT (mặc định) giữ nguyên luồng hiện tại.
                if (HisConfigCFG.EnableTreatmentPrescription)
                {
                    this.FilterMestRoomByStockCategory(ref mestRoomTemps);
                }
        ...
        /// - Kê tủ trực              -> giữ kho có IS_CABINET = 1
        /// - Kê điều trị (buồng bệnh)-> giữ kho có IS_TREATMENT_STOCK = 1
        /// - Kê phòng khám/ngoại trú -> giữ kho có IS_OUTPATIENT_STOCK = 1
        /// </summary>

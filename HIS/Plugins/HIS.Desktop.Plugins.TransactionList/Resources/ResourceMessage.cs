...
namespace HIS.Desktop.Plugins.TransactionList.Resources
{
    class ResourceMessage
    {
        ...
        internal static string GiaoDichMotTheKhongChoPhepXoa
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("Plugins_TransactionList__GiaoDichMotTheKhongChoPhepXoa", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);
        ...
        internal static string KhongChoPhepHoanHuyChiDuocHoanNoiBo
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("Plugins_TransactionList__KhongChoPhepHoanHuyChiDuocHoanNoiBo", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);
        ...
        internal static string HeThongTBCuaSoThongBaoBanCoMuonKhoiPhucDuLieuKhong
        {
            get
            {
                try

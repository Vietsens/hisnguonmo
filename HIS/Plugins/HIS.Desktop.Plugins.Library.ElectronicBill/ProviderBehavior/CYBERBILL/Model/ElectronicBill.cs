...
namespace HIS.Desktop.Plugins.Library.ElectronicBill.ProviderBehavior.CYBERBILL.Model
{
    public class InputElectronicBill
    {
        ...
        public string dnmua_hochieu { get; set; }
    ...
    public class DanhSachChiTiet
    {
        ...
        public string loaihoadondactrung { get; set; }
        public string sokhung { get; set; }
        public string somay { get; set; }
        public string bienkiemsoat { get; set; }
        public string tennguoiguihang { get; set; }
        public string diachinguoiguihang { get; set; }
        public string mstnguoiguihang { get; set; }
        public string sodinhdanhnguoiguihang { get; set; }
    }

    ...
    public partial class frmConfirmPresBlood : HIS.Desktop.Utility.FormBase
    {
        ...
        (
         ...
         "THUỐC THƯỜNG"
                    ...
                    Inventec.Common.SignLibrary.ADO.InputADO inputADO = new HIS.Desktop.Plugins.Library.EmrGenerate.EmrGenerateProcessor().GenerateInputADOWithPrintTypeCode("Mps00000", printTypeCode, currentModule.RoomId);
        ...
        private void ProcessPrint(String printTypeCode)
        {
            try
            {
                ...
                inputADO = new HIS.Desktop.Plugins.Library.EmrGenerate.EmrGenerateProcessor().GenerateInputADOWithPrintTypeCode("Mps00000", printTypeCode, this.currentModule != null ? this.currentModule.RoomId : 0);
            }
            catch (Exception ex)
            {
                Inventec.Common.Logging.LogSystem.Warn(ex);

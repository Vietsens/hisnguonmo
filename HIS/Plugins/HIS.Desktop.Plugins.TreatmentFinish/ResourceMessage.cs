    ...
    class ResourceMessage
    {
        ...
        internal static string BenhNhanDaHetThoiGianHenKhamTrongNam
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("BenhNhanDaHetThoiGianHenKhamTrongNam", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {

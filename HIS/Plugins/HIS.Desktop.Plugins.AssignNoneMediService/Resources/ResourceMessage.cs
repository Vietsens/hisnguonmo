...
namespace HIS.Desktop.Plugins.AssignNoneMediService.Resources
{
    ...
    {
        static System.Resources.ResourceManager languageMessage = new System.Resources.ResourceManager("HIS.Desktop.Plugins.AssignNoneMediService.Resources.Message.Lang", System.Reflection.Assembly.GetExecutingAssembly());
        ...
        internal static string KhongTimThayDVChuaDuocCauHinh
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("KhongTimThayDVChuaDuocCauHinh", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);
        ...
        internal static string VuiLongChonDichVu
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("VuiLongChonDichVu", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);
        ...
        internal static string _BanCoMuonChiDinhGiuong
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("_BanCoMuonChiDinhGiuong", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);
        ...
        internal static string DienDieuTriCuaBNLa
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("DienDieuTriCuaBNLa", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);
        ...
        internal static string _VuiLongChonDVKhac
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("_VuiLongChonDVKhac", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);
        ...
        internal static string DoTuoiCuaBNKhongPhuHopVoiDieuKienCuaDV
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("DoTuoiCuaBNKhongPhuHopVoiDieuKienCuaDV_", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);
        ...
        internal static string BenhNhanDangThieuVienPhi_0D
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("Plugin_AssignService__BenhNhanDangThieuVienPhi_0D", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);
        ...
        internal static string DichVuADaDuocTietLapDinhKemDichVuB
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("Plugin_AssignService__DichVuADaDuocTietLapDinhKemDichVuB", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);
        ...
        internal static string ChuaNhapChanDoanChinhVaChanDoanSoBo
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("Plugin_AssignService__ChuaNhapChanDoanChinhVaChanDoanSoBo", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);
        ...
        internal static string DichVuCoDTTTBatBuocNhungKhongCoChinhSachGia
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("Plugin_AssignService__DichVuCoDTTTBatBuocNhungKhongCoChinhSachGia", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);
        ...
        internal static string DichVuCoDTPTBatBuocNhungKhongCoChinhSachGia
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("Plugin_AssignService__DichVuCoDTPTBatBuocNhungKhongCoChinhSachGia", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);
        ...
        internal static string CacDichVuTrongGoiChuaDuocThietLapChinhSachGiaHoacPhongThucHien
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("CacDichVuTrongGoiChuaDuocThietLapChinhSachGiaHoacPhongThucHien", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);
        ...
        internal static string GoiDichVuChuaDuocThietLapDichVu
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("GoiDichVuChuaDuocThietLapDichVu", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);
        ...
        internal static string KhoaChiDinhChuaTaoBienBanHoiChuan
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("KhoaChiDinhChuaTaoBienBanHoiChuan", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);
        ...
        internal static string KhongDuocNamGhepGiuong
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("KhongDuocNamGhepGiuong", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Error(ex);
        ...
        internal static string GiuongDaVuotQuaSucChua
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("GiuongDaVuotQuaSucChua", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Error(ex);
        ...
        internal static string DichVuCoThongTinGiuongChiDuocChiDinhTrongNgay
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("SereServWithBed_DichVuCoThongTinGiuongChiDuocChiDinhTrongNgay", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Error(ex);
        ...
        internal static string DichVuThieuThongTinGiuong
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("SereServWithBed_DichVuThieuThongTinGiuong", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Error(ex);
        ...
        internal static string DichVuVuotQuaSoLuongThucHien
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("AssignService_DichVuVuotQuaSoLuongThucHien", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Error(ex);
        ...
        internal static string KhongPhaiNoiTruChiDinhGiuong
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("SereServWithBed_KhongPhaiNoiTruChiDinhGiuong", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Error(ex);
        ...
        internal static string ChanKhongPhaiNoiTruChiDinhGiuong
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("SereServWithBed_ChanKhongPhaiNoiTruChiDinhGiuong", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Error(ex);

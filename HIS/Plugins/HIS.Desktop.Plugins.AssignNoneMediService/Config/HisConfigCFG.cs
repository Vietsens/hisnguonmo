...
namespace HIS.Desktop.Plugins.AssignNoneMediService.Config
{
    class HisConfigCFG
    {
        ...
        private const string CONFIG_KEY__IsAutoCheckPriorityForPrioritizedExam = "HIS.Desktop.Plugins.AssignNoneMediService.IsAutoCheckPriorityForPrioritizedExam";
        private const string CONFIG_KEY__IsSingleCheckservice = "HIS.Desktop.Plugins.AssignNoneMediService.IsSingleCheckservice";
        private const string CONFIG_KEY__IsSearchAll = "HIS.Desktop.Plugins.AssignNoneMediService.IsSearchAll";
        private const string CONFIG_KEY__ShowRequestUser = "HIS.Desktop.Plugins.AssignConfig.ShowRequestUser";
        private const string CONFIG_KEY__NoDifference = "HIS.Desktop.Plugins.AssignNoneMediService.NoDifference";
        private const string CONFIG_KEY__HeadCardNumberNoDifference = "HIS.Desktop.Plugins.AssignNoneMediService.HeadCardNumberNoDifference";
        private const string CONFIG_KEY__DepartmentCodeNoDifference = "HIS.Desktop.Plugins.AssignNoneMediService.DepartmentCodeNoDifference";
        ...
        private const string CONFIG_KEY__AssignServicePrintTEST = "HIS.Desktop.Plugins.AssignNoneMediServicePrintTEST";
        ...
        internal const string SERVICE_HAS_PAYMENT_LIMIT_BHYT = "HIS.Desktop.Plugins.AssignNoneMediService.ServiceHasPaymentLimitBHYT";
        internal const string AUTO_FILTER_ROW = "HIS.Desktop.Plugins.AssignNoneMediService.AutoFilterRow";
        ...
        private const string CONFIG_KEY__IsNotAutoLoadServiceOpenAssignService = "HIS.Desktop.Plugins.AssignNoneMediService.IsNotAutoLoadAssignService";
        private const string CONFIG_KEY__IsloadIcdFromExamServiceExecute = "HIS.Desktop.Plugins.IsloadIcdFromExamServiceExecute";
        private const string CONFIG_KEY__IsAllowingChooseServiceWhichInAttachments = "HIS.Desktop.Plugins.AssignNoneMediService.IsAllowingChooseServiceWhichInAttachments";
        ...
        private const string CONFIG_KEY__ShowDefaultExecuteRoom = "HIS.Desktop.Plugins.AssignNoneMediService.ShowDefaultExecuteRoom";
        private const string CONFIG_KEY__BhytColorCode = "HIS.Desktop.Plugins.AssignNoneMediService.BhytServiceColorCode";
        private const string CONFIG_KEY__SetRequestRoomByBedRoomWhenBeingInSurgery = "HIS.Desktop.Plugins.AssignNoneMediService.SetRequestRoomByBedRoomWhenBeingInSurgery";
        private const string CONFIG_KEY__IS_TRACKING_REQUIRED = "MOS.HIS_SERVICE_REQ.ASSIGN_SERVICES.IS_TRACKING_REQUIRED";
        private const string CONFIG_KEY__ALLOW_SHOWING_ANAPATHOLY = "HIS.Desktop.Plugins.AssignNoneMediService.AllowShowingAnapathology";
        ...
        private const string CONFIG_KEY_AssignBedServiceWithBedInfo = "HIS.Desktop.Plugins.AssignNoneMediService.AssignBedServiceWithBedInfo";
        ...
        private const string CONFIG_KEY__BedServiceType_NotAllow_For_OutPatient = "HIS.Desktop.Plugins.AssignNoneMediService.BedServiceType_NotAllow_For_OutPatient";

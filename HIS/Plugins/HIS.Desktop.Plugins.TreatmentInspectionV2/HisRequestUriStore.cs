...
namespace HIS.Desktop.Plugins.TreatmentInspectionV2
{
    class HisRequestUriStore
    {
        ...
        // Inspection list received from the health insurance appraiser
        internal const string HIS_RECORD_INSPECTION_IMP_GET = "api/HisRecordInspectionImp/Get";
        internal const string HIS_RECORD_INSPECTION_IMP_CREATE_LIST = "api/HisRecordInspectionImp/CreateList";

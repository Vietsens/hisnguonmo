    ...
    public partial class UCImportBloodPlus : HIS.Desktop.Utility.UserControlBase
    {
        ...
        private void LoadKeyUCLanguage()
        {
            try
            {
                ...
                this.layoutQrBloodBag.Text = Inventec.Common.Resource.Get.Value("IVT_LANGUAGE_KEY__UC_IMPORT_BLOOD__LAYOUT_QR_BLOOD_BAG", Base.ResourceLangManager.LanguageUCImportBlood, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                this.layoutQrBloodBag.OptionsToolTip.ToolTip = Inventec.Common.Resource.Get.Value("IVT_LANGUAGE_KEY__UC_IMPORT_BLOOD__TOOLTIP_QR_BLOOD_BAG", Base.ResourceLangManager.LanguageUCImportBlood, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                this.txtQrBloodBag.ToolTip = Inventec.Common.Resource.Get.Value("IVT_LANGUAGE_KEY__UC_IMPORT_BLOOD__TOOLTIP_QR_BLOOD_BAG", Base.ResourceLangManager.LanguageUCImportBlood, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
        ...
        private void txtDOB_BloodGiver_ButtonClick(object sender, ButtonPressedEventArgs e)
        {
            try
            {
                ...
                {
                    DateTime? dt = DateTimeHelper.ConvertDateStringToSystemDate(this.
                        Text);
        ...
        private void dtDOB_BloodGiver_Closed(object sender, ClosedEventArgs e)
        {
            try
            {
                if (e.CloseMode == DevExpress.XtraEditors.PopupCloseMode.Normal)
                {
                    ...
                    {
                        //qtcode
                        this.txtDOB_BloodGiver.Text = null;

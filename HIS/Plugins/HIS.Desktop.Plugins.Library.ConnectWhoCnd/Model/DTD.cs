...
{
    internal class DTD : BENH_NHAN
    {
        public DTD(HIS_TREATMENT data)
            : base(data)
        {
            HUT_THUOC = 2;
            RUOU_BIA = 2;
        ...
        /// <summary>
        /// Ghi chỉ số đường huyết. Nếu có phần thập phân biểu thị bằng dấu chấm “.”
        /// </summary>
        public string DUONG_HUYET { get; set; }
        /// <summary>
        /// Ghi chỉ số HbA1C. Nếu có phần thập phân biểu thị bằng dấu chấm “.”
        /// Điều kiện: >4 và <14
        /// </summary>
        ...
        /// <summary>
        /// Ghi thông tin về việc người bệnh biết xử lý đường huyết theo mã dưới:
        /// - Không: 0
        /// - Có: 1
        /// - Không có thông tin/chưa áp dụng: 2
        /// </summary>
        public int? BIET_XU_LY_DUONG_HUYET { get; set; }
        /// <summary>
        /// Ghi thông tin về việc theo dõi biến chứng theo mã dưới:
        /// - Không: 0
        /// - Có: 1
        /// - Không có thông tin/chưa áp dụng: 2
        /// </summary>
        public int? THEO_DOI_BIEN_CHUNG { get; set; }

        public string ROI_LOAN_LIPIT_MAU { get; set; }
        /// <summary>
        /// Ghi theo mã dưới:
        /// - Không: 0
        /// - Có: 1
        /// - Không có thông tin/chưa áp dụng: 2
        /// </summary>
        public int? THUC_HANH_GIAM_AN_MUOI { get; set; }
        /// <summary>
        /// Ghi theo mã dưới:
        /// - Không: 0
        /// - Có: 1
        /// - Không có thông tin/chưa áp dụng: 2
        /// </summary>
        public int? THUC_HANH_AN_UONG { get; set; }
        /// <summary>
        ...
        /// Ví dụ: Metformin 850mg x 28v/28 ngày
        /// </summary>

...
namespace HIS.Desktop.Plugins.Library.ConnectWhoCnd
{
    public class ConnectWhoCndProcessor
    {
        ...
        private static void InitThreadSync(HIS_TREATMENT data, HIS_DHST dhst, List<HIS_SERE_SERV> V_HIS_SERE_SERVs, List<HIS_SERE_SERV_TEIN> ssTein)
        {
            try
            {
        ...
        private static void SendDataWithoutCheck(object obj)
        {
            try
            {
                ...
                if (Configs.IS_CONNECT)
                {
                    ...
                    List<HIS_SERE_SERV> V_HIS_SERE_SERVs = datas.V_HIS_SERE_SERVs;

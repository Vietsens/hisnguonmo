    ...
    public partial class UCExportXml : HIS.Desktop.Utility.UserControlBase
    {
        ...
        private void GeneratePopupMenu()
        {
            try
            {
                ...
                menu.Items.Add(new DevExpress.Utils.Menu.DXMenuItem("Gửi XML 3176", new EventHandler(btnXML3176_Click)));

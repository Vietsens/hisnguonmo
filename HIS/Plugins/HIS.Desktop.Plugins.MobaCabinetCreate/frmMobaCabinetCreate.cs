        ...
        private bool delegateRunPrint(string printTypeCode, string fileName)
        {
            ...
            try
            {
                ...
                if (this.resultMobaSdo != null)
                {
                    ...
                    Inventec.Common.SignLibrary.ADO.InputADO inputADO = new HIS.Desktop.Plugins.Library.EmrGenerate.EmrGenerateProcessor().GenerateInputADOWithPrintTypeCode(this.hisExpMest != null ? this.hisExpMest.TDL_TREATMENT_CODE : printTypeCode, printTypeCode, this.currentModule != null ? currentModule.RoomId : 0);

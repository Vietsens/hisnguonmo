            ...
            try
            {
                if (_lstTreatment != null && _lstTreatment.Count > 0)
                {
                    if (IsGroupTreatmentList)
                    {
                        ...
                        mps000276RDO._PatientTypeAlterList = _LstPatientTypeAlter;
                        mps000276RDO._TreatmentList = _lstTreatment;

...
namespace HIS.Desktop.Plugins.AssignPrescriptionPK.Resources
{
    class ResourceMessage
    {
        ...
        /// <summary>Vui lòng chọn gói bệnh nhân.</summary>
        internal static string VuiLongChonGoiBenhNhan
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("VuiLongChonGoiBenhNhan", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
        ...
        internal static string VuiLongChonItNhatMotDichVu
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("VuiLongChonItNhatMotDichVu", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);
        ...
        /// <summary>Dịch vụ {0} không có trong kho đã chọn nên không thể đưa vào đơn.</summary>
        internal static string DichVuKhongCoTrongKhoDaChon
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("DichVuKhongCoTrongKhoDaChon", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);
        ...
        /// <summary>Việc 2.6: Bệnh {0} là nguyên nhân tử vong không được sử dụng cho các trường hợp không phải tử vong.</summary>

...
namespace HIS.Desktop.Plugins.AssignPrescriptionPK.Config
{
    class HisConfigCFG
    {
        ...
        private const string KEY_WARNING_MONTHS_IN_PROGRAM = "HIS.Desktop.Plugins.RegisterV2.WarningOverMonthsInProgram";
        ...
        internal static string WarningOverMonthsInProgram;
        ...
        internal static void LoadConfig()
        {
            try
            {
                ...
                WarningOverMonthsInProgram = GetValue(KEY_WARNING_MONTHS_IN_PROGRAM);
            }
            catch (Exception ex)
            {
                Inventec.Common.Logging.LogSystem.Error(ex);

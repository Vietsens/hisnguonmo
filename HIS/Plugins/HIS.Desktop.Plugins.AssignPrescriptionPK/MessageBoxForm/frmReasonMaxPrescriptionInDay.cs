...
{
    public partial class frmReasonMaxPrescriptionInDay : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmReasonMaxPrescriptionInDay(string _PrescriptionMessage, LyDoKeThuocQuaSoLuong _LyDoKeThuocQuaSoLuong, string _LyDoKeQuaSL)
        {
            InitializeComponent();
        ...
        private void frmReasonMaxPrescriptionInDay_Load(object sender, EventArgs e)
        {

            try
            {
                Resources.ResourceLanguageManager.LanguagefrmReasonMaxPrescription = new ResourceManager("HIS.Desktop.Plugins.AssignPrescriptionPK.Resources.Lang", typeof(HIS.Desktop.Plugins.AssignPrescriptionPK.MessageBoxForm.frmReasonMaxPrescriptionInDay).Assembly);

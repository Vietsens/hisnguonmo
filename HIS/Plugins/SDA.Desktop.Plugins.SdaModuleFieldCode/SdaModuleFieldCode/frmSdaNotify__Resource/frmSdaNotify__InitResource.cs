 ...
 */
        private void SetCaptionByLanguageKey()
        {
            try
            {
                ...
                Resources.ResourceLanguageManager.LanguageResource = new ResourceManager("HIS.Desktop.Plugins.SdaNotify.Resources.Lang", typeof(HIS.Desktop.Plugins.SdaNotify.SdaNotify.frmSdaNotify__Resource).Assembly);
                ...
                this.Text = Inventec.Common.Resource.Get.Value("frmSdaNotify.Text", Resources.ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
            }
            catch (Exception ex)
            {

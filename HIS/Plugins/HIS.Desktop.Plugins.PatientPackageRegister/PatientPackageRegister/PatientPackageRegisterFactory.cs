...
{
    class PatientPackageRegisterFactory
    {
        internal static IPatientPackageRegister MakeIPatientPackageRegister(CommonParam param, object[] data)
        {
            IPatientPackageRegister result = null;
            try
            {
                result = new PatientPackageRegisterBehavior(param, data);

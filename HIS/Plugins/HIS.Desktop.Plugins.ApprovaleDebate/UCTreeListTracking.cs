...
namespace HIS.Desktop.Plugins.ApprovaleDebate
{
    public partial class UCTreeListTracking : UserControl
    {
        ...
        public UCTreeListTracking(ImageCollection image, Inventec.Desktop.Common.Modules.Module _currentModule)
        {
            InitializeComponent();
            try
            {
        ...
        private void UCTreeListTracking_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void toolTipController2_GetActiveObjectInfo(object sender, ToolTipControllerGetActiveObjectInfoEventArgs e)
        {
            try
            {
                ...
                //                {
                //                    textx = Inventec.Common.Resource.Get.Value("IVT_LANGUAGE_KEY__UC_BED_ROOM_PARTIAL__TREE_SERE_SERV__THOI_GIAN_Y_LENH", Resources.ResourceLanguageManager.LanguageResource__UCTreeListTracking, LanguageManager.GetCulture());
                //                }
                //                if (!o.HasChildren)
                //                {
                ...
                //        //{
                //        //    string textx = Inventec.Common.Resource.Get.Value("IVT_LANGUAGE_KEY__UC_BED_ROOM_PARTIAL__TREE_SERE_SERV__SUA", Resources.ResourceLanguageManager.LanguageResource__UCTreeListTracking, LanguageManager.GetCulture());
                //        //    info = new DevExpress.Utils.ToolTipControlInfo(o, textx);
                //        //    e.Info = info;
                //        //}
                //        //if (hi.Column.FieldName == "Delete")
                //        //{
                //        //    string textx = Inventec.Common.Resource.Get.Value("IVT_LANGUAGE_KEY__UC_BED_ROOM_PARTIAL__TREE_SERE_SERV__XOA", Resources.ResourceLanguageManager.LanguageResource__UCTreeListTracking, LanguageManager.GetCulture());
                //        //    info = new DevExpress.Utils.ToolTipControlInfo(o, textx);
                //        //    e.Info = info;
                //        //}
                //    }

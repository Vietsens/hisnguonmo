...
{
    delegate void PaanMouseRight_Click(object sender, ItemClickEventArgs e);

    class PaanPopupMenuProcessor
    {
        MOS.EFMODEL.DataModels.L_HIS_SERVICE_REQ serviceReqRightClick;
        PaanMouseRight_Click executeRoomMouseRightClick;
        public List<PaanSereServADO> CheckServiceExecuteGroup = new List<PaanSereServADO>();
        ...
        internal PaanPopupMenuProcessor(MOS.EFMODEL.DataModels.L_HIS_SERVICE_REQ currentServiceReq, PaanMouseRight_Click executeRoomMouseRightClick, BarManager barManager, long _roomId, List<HIS.Desktop.Plugins.PaanExecuteList.ADO.PaanSereServADO> CheckServiceExecuteGroup_, MediRecordMenuPopupProcessor _emrMenuPopupProcessor)
        {

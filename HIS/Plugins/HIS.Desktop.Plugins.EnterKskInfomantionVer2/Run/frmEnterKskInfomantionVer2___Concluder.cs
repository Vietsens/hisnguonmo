...
namespace HIS.Desktop.Plugins.EnterKskInfomantionVer2.Run
{
    ...
    {
        /// <summary>Combo "Người khám" (kết luận) bổ sung theo tab (1=trên 18, 2=dưới 18, 3=lái xe).</summary>
        ...
        private void InitConcluderComboForTabs()
        {
            try
            {
                ...
                RegisterConcluderCombo(3, this.cboConcluderLoginName4); // Ksk lái xe
            }

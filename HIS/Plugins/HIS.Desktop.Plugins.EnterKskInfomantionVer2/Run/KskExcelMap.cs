        ...
        public static List<KskExcelRowADO> GetRows(int tabIndex, bool isFemale)
        {
            ...
            switch (tabIndex)
            {
                ...
                case 3:   // Ksk lái xe (16 ô kết quả, 9 ô phân loại)
                    Add(rows, "1. Tâm thần", "txtExamMental4", "cboExamMentalRank4");
                    Add(rows, "Kết luận: (mục 1. Tâm thần)", "txtExamMentalConclude4", null);
                    Add(rows, "2. Thần kinh", "txtExamNeurological4", "cboNeurologicalRank4");
                    Add(rows, "Kết luận: (mục 2. Thần kinh)", "txtNeurologicalConclude4", null);
                    Add(rows, "Kết luận: (mục 3. Mắt)", "txtExamEyeConclude4", null);
                    Add(rows, "Kết luận: (mục 4. Tai mũi họng)", "txtExamEntConclude4", null);
                    Add(rows, "5. Tim mạch: / Tim mạch", "txtExamCardiovascular4", "cboExamCardiovascularRank4");
                    Add(rows, "Kết luận: (mục 5. Tim mạch)", "txtExamCardiovascularConclude4", null);
                    Add(rows, "6. Hô hấp", "txtExamRespiratory4", "cboExamRespiratoryRank4");
                    Add(rows, "Kết luận: (mục 6. Hô hấp)", "txtExamRespiratoryConclude4", null);
                    Add(rows, "7. Cơ xương khớp", "txtExamMuscleBone4", "cboExamMuscleBoneRank4");
                    Add(rows, "Kết luận: (mục 7. Cơ xương khớp)", "txtExamMuscleBoneConclude4", null);
                    Add(rows, "8. Nội tiết", "txtExamOend4", "cboExamOendRank4");
                    Add(rows, "Kết luận: (mục 8. Nội tiết)", "txtExamOendConclude4", null);
                    Add(rows, "9. Thai sản", "txtExamMaternity4", "cboExamMaternityRank4");
                    Add(rows, "Kết luận: (mục 9. Thai sản)", "txtExamMaternityConclude4", null);
                    Add(rows, "Phân loại (3. Mắt)", null, "cboExamEyeRank4");
                    Add(rows, "Phân loại (4. Tai mũi họng)", null, "cboExamEntDiseaseRank4");
                ...
                case 4:   // Ksk lái xe ô tô (7 ô kết quả, 9 ô phân loại)
                    Add(rows, "1. Tâm thần", "txtExamMental5", "cboExamMentalRank5");
                    Add(rows, "2. Thần kinh", "txtExamNeurological5", "cboExamNeurologicalRank5");
                    Add(rows, "Tim mạch", "txtExamCardiovascular5", "cboExamCardiovascularRank5");
                    Add(rows, "4. Hô hấp", "txtExamRespiratory5", "cboExamRespiratoryRank5");
                    Add(rows, "5. Cơ xương khớp", "txtExamMuscleBone5", "cboExamMuscleBoneRank5");
                    Add(rows, "6. Nội tiết", "txtExamOend5", "cboExamOendRank5");
                    Add(rows, "7. Thai sản", "txtExamMaternity5", "cboExamMaternityRank5");
                    Add(rows, "Phân loại (Mắt)", null, "cboExamEyeRank5");
                    Add(rows, "Phân loại (Tai mũi họng)", null, "cboExamEntDiseaseRank5");

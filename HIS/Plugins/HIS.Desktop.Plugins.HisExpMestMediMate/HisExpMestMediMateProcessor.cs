...
using HIS.Desktop.Plugins.HisExpMestMediMate;
using System;
...
namespace HIS.Desktop.Plugins.HisExpMestMediMate
{
    [ExtensionOf(typeof(DesktopRootExtensionPoint),
       "HIS.Desktop.Plugins.HisExpMestMediMate",
       "Danh mục",
       "Bussiness",
       4,
    ...
    public class HisPatientProgramProcessor : ModuleBase, IDesktopRoot
    {
        ...
        public object Run(object[] args)
        {
            ...
            try
            {
                IHisExpMestMediMate behavior = HisExpMestMediMateFactory.MakeIControl(param, args);

...
{
    public partial class frmHisExpMestMediMate : HIS.Desktop.Utility.FormBase
    {
        UCHisExpMestMediMate uc;
        string pakage_number = "";
        public frmHisExpMestMediMate(Inventec.Desktop.Common.Modules.Module _module)
            : base(_module)
        {
            InitializeComponent();
            SetIcon();
            ...
            uc = new UCHisExpMestMediMate(_module);

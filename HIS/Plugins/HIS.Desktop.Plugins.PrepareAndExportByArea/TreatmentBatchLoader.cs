...
{
    /// <summary>
    /// Tra cuu HIS_TREATMENT theo danh sach ID cho man Soan phat thuoc theo khu.
    /// Ban sao cua TreatmentBatchLoader trong HIS.Desktop.Plugins.PrepareAndExport — sua mot ben thi
    /// nho soat ben con lai.
    ///

    ...
    public partial class UCRegister : UserControlBase
    {
        ...
        private void FillDataPatientToControl(HisPatientSDO patientDTO)
        {
            try
            {
                ...
                var commune = SdaCommunes.Where(o => o.IS_ACTIVE == IMSys.DbConfig.SDA_RS.COMMON.IS_ACTIVE__TRUE).FirstOrDefault(o =>
        ...
        private void SetValueNew(HisPatientSDO patientDTO)
        {
            try
            {
                ...
                ((o.INITIAL_NAME + " " + o.COMMUNE_NAME) == patientDTO.COMMUNE_NAME || o.COMMUNE_NAME == patientDTO.COMMUNE_NAME)
                ...
                else if (patientDTO.PROVINCE_CODE != null && patientDTO.COMMUNE_CODE != null)
                {
                    var communeTHX = workingCommuneADO.FirstOrDefault(o =>
        ...
        private long getIdPatient(string patientCode )
        {
            long patientId = 0;
            try
            {
                ...
                var patientList = new BackendAdapter(paramCommon)
                                .Get<List<HIS_PATIENT>>("api/HisPatient/Get", ApiConsumers.MosConsumer, filter, paramCommon)
                                .ToList();
                patientId = patientList?.FirstOrDefault()?.ID ?? 0;
            ...
            try
            {
                ...
                if (data != null)
                {
                    ...
                    if (data is HisPatientSDO)
                    {
                        ...
                        {                     
                            var id = getIdPatient(txtPatientCode.Text.ToString());

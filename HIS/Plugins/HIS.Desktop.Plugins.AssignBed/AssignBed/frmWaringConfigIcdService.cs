...
namespace HIS.Desktop.Plugins.AssignBed.AssignBed
{
    public partial class frmWaringConfigIcdService : Form
    {
        ...
        public frmWaringConfigIcdService(List<HIS_ICD> _icdCodeFromUc, List<DataGridAdo> _serviceCheckeds__Send, Inventec.Desktop.Common.Modules.Module _currentModule, DelegateSelectData _delegateSelectData)
        {
            InitializeComponent();

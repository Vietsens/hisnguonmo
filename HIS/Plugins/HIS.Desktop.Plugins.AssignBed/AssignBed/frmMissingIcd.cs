...
namespace HIS.Desktop.Plugins.AssignBed.AssignBed
{
    public partial class frmMissingIcd : HIS.Desktop.Utility.FormBase
    {
        ...
        List<DataGridAdo> serviceCheckeds__Send;
        ...
        /// <summary>
        /// </summary>
        public frmMissingIcd(List<HIS_ICD> _icdCodeFromUc, List<DataGridAdo> _serviceCheckeds__Send, Inventec.Desktop.Common.Modules.Module _currentModule, List<HIS_ICD_SERVICE> _icdServices, DelegateSelectData _delegateSelectData,bool VisibleButtonSkip = false, Action<bool> getSkip = default(Action<bool>))
            : base(_currentModule)
        {
            InitializeComponent();
        ...
        private void SetCaptionByLanguageKey()
        {
            ...
            {
                ////Khoi tao doi tuong resource
                Resources.ResourceLanguageManager.LanguageResource__frmDetail = new ResourceManager("HIS.Desktop.Plugins.AssignService.Resources.Lang", typeof(HIS.Desktop.Plugins.AssignBed.AssignBed.frmDetail).Assembly);

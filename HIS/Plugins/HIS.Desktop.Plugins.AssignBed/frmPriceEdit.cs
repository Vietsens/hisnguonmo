...
namespace HIS.Desktop.Plugins.AssignBed
{
    ...
    {
        DataGridAdo sereServADOOld;
        Action<DataGridAdo> actEditedHandler;
        //GetPriceBypackageDelegate getPriceBypackageDelegate;
        GetPriceBySurgDelegate getPriceBySurgDelegate;
        int ActionType;

		public frmPriceEdit(DataGridAdo data, Action<DataGridAdo> actEdited, int actionType, GetPriceBySurgDelegate getPriceBySurgDelegate)
        {
            InitializeComponent();
    ...
    public delegate decimal? GetPriceBySurgDelegate(DataGridAdo sereServADOOld);
}

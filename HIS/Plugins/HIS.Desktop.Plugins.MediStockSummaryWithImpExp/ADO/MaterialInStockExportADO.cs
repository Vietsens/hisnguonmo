...
namespace HIS.Desktop.Plugins.MediStockSummaryWithImpExp.ADO
{
    public class MaterialInStockExportADO : MOS.EFMODEL.DataModels.V_HIS_MATERIAL_BEAN
    {
        ...
        public string PARENT_GROUP_NAME { get; set; } // Nhóm cha (lấy từ node cha trực tiếp trong cây tồn kho)
        ...
        public decimal TOTAL_IMPORT { get; set; }   // Tổng nhập trong kỳ
        public decimal TOTAL_EXPORT { get; set; }    // Tổng xuất trong kỳ
        public decimal ENDING_BALANCE { get; set; }  // Tồn cuối kỳ
    }
}

                    ...
                    if (keyPrintType == 1)
                    {
                        ...
                        BackendDataWorker.Get<V_HIS_MEDICINE_TYPE>(),
                         ...
                         treatment
                            ...
                            WaitingManager.Hide();
                            result = MpsPrinterRun(printTypeCode, fileName, mps000245RDO);
                        }
                    }
                    else
                    {
                    ...
                    this._ImpMestMaterials = item.Value._ImpMestMaterials;
                    {
                        ...
                        BackendDataWorker.Get<V_HIS_ROOM>(),this._MobaExpMests,
                         ...
                         this.listAggrImpMest1
                            ...
                            WaitingManager.Hide();
                            result = MpsPrinterRun(printTypeCode, fileName, mps000100RDO); result = MpsPrinterRun(printTypeCode, fileName, mps000100RDO);
                        }
                        #endregion

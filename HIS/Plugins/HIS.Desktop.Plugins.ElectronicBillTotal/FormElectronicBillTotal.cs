            ...
            try
            {
                ...
                else
                {
                    ...
                    if (apiResult)
                    {
                        ...
                        resultTranBill.INVOICE_LOOKUP_CODE = electronicBillResult.InvoiceLookupCode;
                    }
                    else
                    {

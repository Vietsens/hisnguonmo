...
namespace HIS.Desktop.Plugins.Library.PrintBordereau.MpsBehavior.Mps000512
{
    // PTTK 2689 — mục 3.5: Bảng kê tổng hợp 697/QĐ-BYT
    // Logic xử lý giống Mps000302Behavior (chỉ thay namespace PDO + template Mps000512)
    class Mps000512Behavior : MpsDataBase, ILoad
    {
        public Mps000512Behavior(long? roomId, V_HIS_PATIENT_TYPE_ALTER currentPatientTypeAlter, List<HIS_SERE_SERV> _sereServs,
        ...
        bool ILoad.Load(string printTypeCode, string fileName, Inventec.Common.FlexCelPrint.DelegateReturnEventPrint returnEventPrint)
        {
            ...
            try
            {
                MPS.Processor.Mps000512.PDO.Config.HeinServiceTypeCFG heinServiceType = new MPS.Processor.Mps000512.PDO.Config.HeinServiceTypeCFG();
                ...
                MPS.Processor.Mps000512.PDO.Config.PatientTypeCFG patientTypeCFG = new MPS.Processor.Mps000512.PDO.Config.PatientTypeCFG();
                ...
                PrintCustomShow<Mps000512PDO> printShow = new PrintCustomShow<Mps000512PDO>(printTypeCode, fileName, rdo, returnEventPrint, this.isPreview);

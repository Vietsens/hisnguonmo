...
namespace HIS.Desktop.Plugins.Library.PrintBordereau.Mps000508
{
    // PTTK 2689 — mục 3.5: Bảng kê ngoại trú BHYT theo QĐ 697/QĐ-BYT
    // Logic xử lý giống Mps000279Behavior (chỉ thay namespace PDO + template Mps000508)
    // Mps000509 (nội trú BHYT 697) tái sử dụng class này (giống Mps000280 reuse Mps000279)
    public class Mps000508Behavior : MpsDataBase, ILoad
    {
        private string documentName;
        public Mps000508Behavior(long? roomId, V_HIS_PATIENT_TYPE_ALTER currentPatientTypeAlter, List<HIS_SERE_SERV> _sereServs,
        ...
        bool ILoad.Load(string printTypeCode, string fileName, Inventec.Common.FlexCelPrint.DelegateReturnEventPrint returnEventPrint)
        {
            ...
            try
            {
                MPS.Processor.Mps000508.PDO.Config.HeinServiceTypeCFG heinServiceType = new MPS.Processor.Mps000508.PDO.Config.HeinServiceTypeCFG();
                ...
                MPS.Processor.Mps000508.PDO.Config.PatientTypeCFG patientTypeCFG = new MPS.Processor.Mps000508.PDO.Config.PatientTypeCFG();
                ...
                PrintCustomShow<Mps000508PDO> printShow = new PrintCustomShow<Mps000508PDO>(printTypeCode, fileName, rdo, returnEventPrint, this.isPreview);

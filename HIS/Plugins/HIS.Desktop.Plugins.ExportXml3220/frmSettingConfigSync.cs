...
namespace HIS.Desktop.Plugins.ExportXml3220
{
    public partial class frmSettingConfigSync : HIS.Desktop.Utility.FormBase
    {
        ...
        /// <summary>
        ///Hàm xét ngôn ngữ cho giao diện frmSettingConfigSync
        /// </summary>
        private void SetCaptionByLanguageKey()
        {
            try
            {
                ...
                Resources.ResourceLanguageManager.LanguageResource = new ResourceManager("HIS.Desktop.Plugins.ExportXml3220.Resources.Lang", typeof(frmSettingConfigSync).Assembly);
                ...
                //this.chkXML3176.Properties.Caption = Inventec.Common.Resource.Get.Value("frmSettingConfigSync.chkXML3176.Properties.Caption", Resources.ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                //this.chkDontSend.Properties.Caption = Inventec.Common.Resource.Get.Value("frmSettingConfigSync.chkDontSend.Properties.Caption", Resources.ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                //this.chkDontSend.ToolTip = Inventec.Common.Resource.Get.Value("frmSettingConfigSync.chkDontSend.ToolTip", Resources.ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                //this.chkCollinearXML.Properties.Caption = Inventec.Common.Resource.Get.Value("frmSettingConfigSync.chkCollinearXML.Properties.Caption", Resources.ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                ...
                //this.layoutControlItem4.Text = Inventec.Common.Resource.Get.Value("frmSettingConfigSync.layoutControlItem4.Text", Resources.ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                //this.layoutControlItem5.OptionsToolTip.ToolTip = Inventec.Common.Resource.Get.Value("frmSettingConfigSync.layoutControlItem5.OptionsToolTip.ToolTip", Resources.ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                //this.layoutControlItem5.Text = Inventec.Common.Resource.Get.Value("frmSettingConfigSync.layoutControlItem5.Text", Resources.ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());

    ...
    public partial class frmSettingSavePath : HIS.Desktop.Utility.FormBase
    {
        ...
        private void SetCaptionByLanguageKey()
        {
            try
            {
                ...
                this.lciPathCollinearXml.OptionsToolTip.ToolTip = Inventec.Common.Resource.Get.Value("frmSettingSavePath.lciPathCollinearXml.OptionsToolTip.ToolTip", Resources.ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                this.lciPathCollinearXml.Text = Inventec.Common.Resource.Get.Value("frmSettingSavePath.lciPathCollinearXml.Text", Resources.ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());

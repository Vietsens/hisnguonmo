...
namespace HIS.Desktop.Plugins.ApprovalExamAnesthesia.Key
{
    class HisConfigCFG
    {
        ...
        internal static string EmrFormCodes
        {
            get
            {
                var emr = HisConfigs.Get<string>(Key.HisConfigKeys.HIS_CONFIG_KEY__EMR_FORM_CODES);
                return emr;
            }
        }
    }

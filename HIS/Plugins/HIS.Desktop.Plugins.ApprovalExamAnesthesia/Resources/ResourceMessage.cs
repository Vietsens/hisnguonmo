...
namespace HIS.Desktop.Plugins.ApprovalExamAnesthesia.Resources
{
    ...
    {
        static System.Resources.ResourceManager languageMessage = new System.Resources.ResourceManager("HIS.Desktop.Plugins.ApprovalExamAnesthesia.Resources.Message.Lang", System.Reflection.Assembly.GetExecutingAssembly());
        ...
        internal static string ToolTipLeaves
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("Plugins_ApprovalExamAnesthesia__ToolTipLeaves", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);

...
{
    class PharmacologyFactory
    {
        internal static IPharmacology MakeIControl(CommonParam param, object[] data)
        {
            IPharmacology result = null;
            try
            {
                result = new PharmacologyBehavior(param, data);

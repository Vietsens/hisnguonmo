    ...
    public partial class UCRegister : UserControlBase
    {
        private void FillDataAfterSaerchPatientInUCPatientRaw(DataResultADO dt)
        {
            try
            {
                ...
                else if (dt.HisPatientSDO != null && dt.HisPatientSDO.TreatmentId == nullHIS.Desktop.Plugins.Library.RegisterConfig.AppConfigs.CheDoTuDongFillDuLieuDiaChiGhiTrenTheVaoODiaChiBenhNhanHayKhong == 2)
                {

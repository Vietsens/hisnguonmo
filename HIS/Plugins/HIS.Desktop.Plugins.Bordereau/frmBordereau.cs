...
namespace HIS.Desktop.Plugins.Bordereau
{
    public partial class frmBordereau : FormBase
    {
        ...
        /// <summary>
        /// Tập SERVICE_ID của loại vật tư tích "Không hao phí" (HIS_MATERIAL_TYPE.IS_NOT_EXPEND = 1).
        /// Tương đương cờ NotExpend lấy từ D_HIS_MEDI_STOCK bên màn kê đơn: bảng kê không có dữ liệu 
        /// kho theo dòng nên đọc thẳng cờ này từ danh mục loại vật tư.
        /// </summary>
        ...
        private void LoadPicUpdateQR()
        {
            try
            {
                ...
                picUpdateQR.Enabled = (currentTreatment != null && currentTreatment.IS_ACTIVE == 1 && currentTreatment.IS_PAUSE == 1 && totalDepositPrice > 0);
            }
             catch (Exception ex)
            {
                LogSystem.Warn(ex);
        ...
        /// <summary>
        /// Dòng vật tư có loại vật tư tích "Không hao phí" hay không — tương ứng cờ NotExpend bên màn kê đơn.
                ...
                if (e.RowHandle >= 0)
                {
                    if (data != null)
                    {
                        ...
                        else if (e.Column.FieldName == "IsExpend")
                        {
                            ...
                            // Loại vật tư tích "Không hao phí" — cùng quy tắc với cột HP màn kê đơn.
                ...
                if ((Control.ModifierKeys & Keys.Control) != Keys.Control)
                {
                    ...
                    if (hi != null && hi.InRowCell)
                    {
                        ...
                        if (hi.RowHandle >= 0) //(hi.Column.RealColumnEdit.GetType() == typeof(DevExpress.XtraEditors.Repository.RepositoryItemCheckEdit) || hi.Column.RealColumnEdit.GetType() == typeof(DevExpress.XtraEditors.Repository.RepositoryItemTextEdit))
                        {
                            ...
                            //}
                            //else 
                            if (hi.Column.FieldName == "IsNoExecute")
                            {
                            ...
                            else if (hi.Column.FieldName == "IsExpend")
                            {
                                ...
                                if (this.IsNotExpendMaterialType(sereServADO))
                                {
                                    Inventec.Common.Logging.LogSystem.Debug("IsExpend bị disable do loại vật tư tích Không hao phí. return");
                                    return;
                                }

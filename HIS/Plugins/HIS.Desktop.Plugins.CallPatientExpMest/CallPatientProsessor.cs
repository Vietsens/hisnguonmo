 ...
 */
using HIS.Desktop.Plugins.CallPatientExpMest.CallPatientExpMest;
using Inventec.Core;
...
namespace HIS.Desktop.Plugins.CallPatientExpMest
{
    [ExtensionOf(typeof(DesktopRootExtensionPoint),
       "HIS.Desktop.Plugins.CallPatientExpMest",
       "Gọi bênh nhân",
       "Common",
       14,
    ...
    public class CallPatientProsessor : ModuleBase, IDesktopRoot
    {
        ...
        public object Run(object[] args)
        {
            ...
            try
            {
                ICallPatientExpMest behavior = CallPatientExpMestFactory.MakeICallPatient(param, args);

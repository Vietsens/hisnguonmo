    ...
    public partial class frmMobaSaleCreate : HIS.Desktop.Utility.FormBase
    {
        ...
        private bool delegateRunPrintHoaDon(string printTypeCode, string fileName)
        {
            ...
            try
            {
                ...
                Inventec.Common.SignLibrary.ADO.InputADO inputADO = new HIS.Desktop.Plugins.Library.EmrGenerate.EmrGenerateProcessor().GenerateInputADOWithPrintTypeCode(printTypeCode, printTypeCode, currentModule != null ? currentModule.RoomId : 0);

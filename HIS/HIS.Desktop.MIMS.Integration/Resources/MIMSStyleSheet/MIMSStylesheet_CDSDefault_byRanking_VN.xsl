  ...
  <xsl:template match="/">
    <html>
      <head>
				...
				<script type="text/javascript" src="Scripts/OldStyle/jquery-1.12.4.min.js"></script>
        <script type="text/javascript" src="Scripts/OldStyle/jquery-ui.min.js"></script>
        <!-- <script type="text/javascript" src="Scripts/jquery-migrate-3.3.2.min.js"></script> -->
        <xsl:choose>
          <xsl:when test="count(//Interaction) &gt; 0">
            <script type="text/javascript" src="Scripts/drugalert.js"></script>
          </xsl:when>
          <xsl:otherwise>
            <script type="text/javascript" src="Scripts/monograph.js"></script>
          </xsl:otherwise>
        </xsl:choose>
        <style>div.drug-label {	width: 90mm;	height: 35mm; border: 1pt solid; border-radius: 5pt;	padding: 5pt;	margin-bottom: 5pt;	}	.drug-label h4 {	font-size: 14pt;	font-weight: bold;	font-family: Arial;	margin: 2pt;	}	.drug-label p {	font-size: 12pt;	font-weight: normal;	font-family: Arial;	margin: -1pt 2pt 2pt 2pt;	}	.cals-details p {	margin-bottom: 0pt;	}	.cal-details li a {	text-decoration: none;	}	.cal-details strong { margin-right: 2pt; }	ol.allergy-list { padding-left: 1.33em; }	ol.allergy-list > li { padding-top: 0.5em; }	ol.allergy-list h4.subheading { margin-top: 0.2em; }</style>
      </head>
      <body>
  ...
  <xsl:template match="Lactation">
    ...
    <xsl:element name="div">
      ...
      <div>
        ...
        <p>
          <label style="font-size:14px;font-weight:bold;margin-up:-410px">
            Mô tả<br/>
          </label>
    ...
    <xsl:for-each select="//DANH_SACH_TUONG_TAC/CAP_TUONG_TAC">
      ...
      <xsl:element name="div">
        ...
        <div>
          ...
          <h4 class="subheading" style="font-size: 14px;color:red;font-style: italic;">Tuyên Bố Miễn Trừ Trách Nhiệm:</h4>

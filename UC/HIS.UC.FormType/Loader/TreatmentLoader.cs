    ...
    class TreatmentLoader
    {
        public static void LoadDataToCombo(DevExpress.XtraEditors.GridLookUpEdit cboTreatmentType)
        {
            try
            {
                ...
                cboTreatmentType.Properties.DataSource = Config.HisFormTypeConfig.HisTreatments;
                cboTreatmentType.Properties.DisplayMember = "TREATMENT_CODE";
                ...
                GridColumn aColumnCode = cboTreatmentType.Properties.View.Columns.AddField("ID");
                aColumnCode.Caption = "Mã";
                aColumnCode.Visible = true;
                aColumnCode.VisibleIndex = 1;
                aColumnCode.Width = 50;

                GridColumn aColumnName = cboTreatmentType.Properties.View.Columns.AddField("TREATMENT_CODE");

    ...
    class SdaGetString
    {
        public static List<DataGet> Get(string value, string key)
        {
            ...
            try
            {
                ...
                else if (value == "SDA_COMMUNE") datasuft = Config.SdaFormTypeConfig.SdaCommune.Select(o => new DataGet { ID = o.ID, CODE = o.COMMUNE_CODE, NAME = o.COMMUNE_NAME, PARENT = o.DISTRICT_ID ?? 0 }).ToList();

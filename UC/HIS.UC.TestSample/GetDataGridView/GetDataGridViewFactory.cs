...
{
    class GetDataGridViewFactory
    {
        internal static IGetDataGridView MakeIGetDataGridView(CommonParam param, UserControl uc)
        {
            IGetDataGridView result = null;
            try
            {
                if (uc is UserControl)
                {
                    result = new GetDataGridViewBehavior(param, (UserControl)uc);
                }

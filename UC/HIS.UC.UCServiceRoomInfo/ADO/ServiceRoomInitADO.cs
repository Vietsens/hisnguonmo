...
namespace HIS.UC.UCServiceRoomInfo.ADO
{
    public class ServiceRoomInitADO
    {
        public ServiceRoomInitADO() { }
        ...
        public DelegateGetIntructionTime dlgGetIntructionTime { get; set; }
    }
}

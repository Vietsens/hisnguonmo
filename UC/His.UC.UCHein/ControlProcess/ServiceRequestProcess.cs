...
namespace His.UC.UCHein.ControlProcess
{
    public class ServiceRequestProcess
    {
        ...
        public string GetDefaultHeinRatio(BhytPatientTypeData patientTypeData, string heinCardNumber, string treatmentTypeCode, string facilityClassCode = null, string formerLevelCode = null, long point = 0, long ClinicalInTime = 0)
        {
            string result = "";
            try
            {

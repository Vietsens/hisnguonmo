...
using HIS.UC.Speciality.GetDataGridView;
using HIS.UC.Speciality.Reload;
using HIS.UC.Speciality.Run;
using Inventec.Core;
...
{
    public class SpecialityProcessor : BussinessBase
    {
        object uc;
        ...
        public SpecialityProcessor(CommonParam paramBusiness)
            : base(paramBusiness)
        {
        }

        public object Run(SpecialityInitADO arg)
        {
            uc = null;
            try
            {
        ...
        public void Reload(UserControl control, List<SpecialityADO> data)
        {
            try
            {

...
{
    public partial class UCDistrictOfBirth : UserControlBase
    {
        #region Declare
        ...
        public UCDistrictOfBirth()
            : base("UCPlusInfo", "UCDistrictOfBirth")
        {
            try
            {
                InitializeComponent();
        ...
        private void SetCaptionByLanguageKey()
        {
            try
            {
                this.lciDistrictNow.Text = Inventec.Common.Resource.Get.Value("UCPlusInfo.UCDistrictOfBirth", HIS.UC.PlusInfo.ShareMethod.ResourceLanguageManager.ResourceUCPlusInfo, LanguageManager.GetCulture());
            }
            catch (Exception ex)
            {
                Inventec.Common.Logging.LogSystem.Warn(ex);
        ...
        /// <summary>
        ///Hàm xét ngôn ngữ cho giao diện UCDistrictOfBirth
        /// </summary>
        private void SetCaptionByLanguageKeyNew()
        {
            try
            {
                ...
                ResourceLanguageManager.LanguageResource = new ResourceManager("HIS.UC.PlusInfo.Resources.Lang", typeof(UCDistrictOfBirth).Assembly);

                ////Gan gia tri cho cac control editor co Text/Caption/ToolTip/NullText/NullValuePrompt/FindNullPrompt
                this.layoutControl1.Text = Inventec.Common.Resource.Get.Value("UCDistrictOfBirth.layoutControl1.Text", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                this.cboDistrictNowName.Properties.NullText = Inventec.Common.Resource.Get.Value("UCDistrictOfBirth.cboDistrictNowName.Properties.NullText", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                this.lciDistrictNow.OptionsToolTip.ToolTip = Inventec.Common.Resource.Get.Value("UCDistrictOfBirth.lciDistrictNow.OptionsToolTip.ToolTip", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                this.lciDistrictNow.Text = Inventec.Common.Resource.Get.Value("UCDistrictOfBirth.lciDistrictNow.Text", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
            }
            catch (Exception ex)
            {
                Inventec.Common.Logging.LogSystem.Warn(ex);

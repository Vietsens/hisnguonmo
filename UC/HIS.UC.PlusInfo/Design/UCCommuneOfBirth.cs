...
{
    public partial class UCCommuneOfBirth : UserControlBase
    {
        #region Declare
        ...
        public UCCommuneOfBirth()
            : base("UCPlusInfo", "UCCommuneOfBirth")
        {
            try
            {
                InitializeComponent();
        ...
        private void SetCaptionByLanguageKey()
        {
            try
            {
                this.lciCommuneNow.Text = Inventec.Common.Resource.Get.Value("UCPlusInfo.UCCommuneOfBirth", HIS.UC.PlusInfo.ShareMethod.ResourceLanguageManager.ResourceUCPlusInfo, LanguageManager.GetCulture());
            }
            catch (Exception ex)
            {
                Inventec.Common.Logging.LogSystem.Warn(ex);
        ...
        /// <summary>
        ///Hàm xét ngôn ngữ cho giao diện UCCommuneOfBirth
        /// </summary>
        private void SetCaptionByLanguageKeyNew()
        {
            try
            {
                ...
                ResourceLanguageManager.LanguageResource = new ResourceManager("HIS.UC.PlusInfo.Resources.Lang", typeof(UCCommuneOfBirth).Assembly);

                ////Gan gia tri cho cac control editor co Text/Caption/ToolTip/NullText/NullValuePrompt/FindNullPrompt
                this.layoutControl1.Text = Inventec.Common.Resource.Get.Value("UCCommuneOfBirth.layoutControl1.Text", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                this.cboCommuneNowName.Properties.NullText = Inventec.Common.Resource.Get.Value("UCCommuneOfBirth.cboCommuneNowName.Properties.NullText", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                this.lciCommuneNow.OptionsToolTip.ToolTip = Inventec.Common.Resource.Get.Value("UCCommuneOfBirth.lciCommuneNow.OptionsToolTip.ToolTip", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                this.lciCommuneNow.Text = Inventec.Common.Resource.Get.Value("UCCommuneOfBirth.lciCommuneNow.Text", ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
            }
            catch (Exception ex)
            {
                Inventec.Common.Logging.LogSystem.Warn(ex);
        ...
        internal void SetValue(UCPlusInfoADO dataSet)
        {
            try
            {
                ...
                if (commune != null)
                {
                    ...
                    this.cboCommuneNowName.EditValue = commune.ID;
                }
                else
                {

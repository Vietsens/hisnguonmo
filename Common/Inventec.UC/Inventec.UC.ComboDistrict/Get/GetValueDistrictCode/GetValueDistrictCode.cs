...
{
    class GetValueDistrictCode : IGetValueDistrictCode
    {
        public string GetDistrictCode(System.Windows.Forms.UserControl UC)
        {
            string result = null;
            try
            {
                if (UC.GetType() == typeof(Desgin.Template1.Template1))
                {
                    ...
                    result = UCComboDistrict.GetDistrictCode();
                    if (result == null)
                    {

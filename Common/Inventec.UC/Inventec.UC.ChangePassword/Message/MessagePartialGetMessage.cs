            ...
            if (Language == LanguageEnum.Vietnamese)
            {
                switch (enumBC)
                {
                    ...
                    case Enum.NguoiDungNhapTaiKhoanHoacMatKhauKhongChinhXacDeDangNhap: message = MessageViResource.NguoiDungNhapTaiKhoanHoacMatKhauKhongChinhXacDeDangNhap;
                        break;
                    case Enum.MatKhauChuaDatChuanConThieu: message = MessageViResource.MatKhauChuaDatChuanConThieu;
                        break;
                    case Enum.MatKhauChuaDu8KyTu: message = MessageViResource.MatKhauChuaDu8KyTu;
                        break;
                    case Enum.MatKhauThieuChuInHoa: message = MessageViResource.MatKhauThieuChuInHoa;
                        break;
                    case Enum.MatKhauThieuChuThuong: message = MessageViResource.MatKhauThieuChuThuong;
                        break;
                    case Enum.MatKhauThieuChuSo: message = MessageViResource.MatKhauThieuChuSo;
                        break;
                    case Enum.MatKhauThieuKyTuDacBiet: message = MessageViResource.MatKhauThieuKyTuDacBiet;
                        break;
                    case Enum.YeuCauDoPhucTapMatKhau: message = MessageViResource.YeuCauDoPhucTapMatKhau;
                        break;
            ...
            else if (Language == LanguageEnum.English)
            {
                switch (enumBC)
                {
                    ...
                    case Enum.NguoiDungNhapTaiKhoanHoacMatKhauKhongChinhXacDeDangNhap: message = MessageEnResource.NguoiDungNhapTaiKhoanHoacMatKhauKhongChinhXacDeDangNhap;
                        break;
                    case Enum.MatKhauChuaDatChuanConThieu: message = MessageEnResource.MatKhauChuaDatChuanConThieu;
                        break;
                    case Enum.MatKhauChuaDu8KyTu: message = MessageEnResource.MatKhauChuaDu8KyTu;
                        break;
                    case Enum.MatKhauThieuChuInHoa: message = MessageEnResource.MatKhauThieuChuInHoa;
                        break;
                    case Enum.MatKhauThieuChuThuong: message = MessageEnResource.MatKhauThieuChuThuong;
                        break;
                    case Enum.MatKhauThieuChuSo: message = MessageEnResource.MatKhauThieuChuSo;
                        break;
                    case Enum.MatKhauThieuKyTuDacBiet: message = MessageEnResource.MatKhauThieuKyTuDacBiet;
                        break;
                    case Enum.YeuCauDoPhucTapMatKhau: message = MessageEnResource.YeuCauDoPhucTapMatKhau;
                        break;

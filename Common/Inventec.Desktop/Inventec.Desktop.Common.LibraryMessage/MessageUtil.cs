...
namespace Inventec.Desktop.Common.LibraryMessage
{
    public class MessageUtil
    {
        public static string GetMessage(Message.Enum MessageCaseEnum)
        {
            ...
            try
            {
                Message messageCase = LibraryMessage.FontendMessage.Get(LanguageManager.LanguageManager.GetLanguage(), MessageCaseEnum);
                if (messageCase != null)
                {
        ...
        public static void SetMessage(CommonParam param, LibraryMessage.Message.Enum en)
        {
            try
            {
                Message message = LibraryMessage.FontendMessage.Get(LanguageManager.LanguageManager.GetLanguage(), en);
                if (message != null)
                {

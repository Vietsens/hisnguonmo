...
namespace Inventec.Desktop.Core
{
    ...
    public static class Platform
    {
        ...
        //public static Dictionary<string, object> dicPluginAssemblys = new Dictionary<string, object>();
        //public static Dictionary<string, object> dicPluginControls = new Dictionary<string, object>();
            ...
            get
            {
                if (_pluginsDirectory == null)
                {
                    lock (_syncRoot)
                    {
                        if (_pluginsDirectory == null)
                        {
                            var pluginsDirectory = System.IO.Path.Combine(InstallDirectory, ExtensionSettings.Default.PluginPath);
        ...
        private static string GetApplicationDataDirectory()
        {
            ...
            path = System.IO.Path.Combine(path, "Inventec__Inc"); //TODO this seems to be derived from the AssemblyCompanyAttribute

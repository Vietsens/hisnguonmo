...
{
    public class GridLookupEditWithTextEditValidationRule : DevExpress.XtraEditors.DXErrorProvider.ValidationRule
    {
        public DevExpress.XtraEditors.TextEdit txtTextEdit;
        public DevExpress.XtraEditors.GridLookUpEdit cbo;
